...
**Audio:**
- `audio/mungarden-pro.mp3` — "MunGarden Pro", user-supplied track. Ships as a ~1.9 MB MP3. The loop is gated behind a user gesture (clicking ENTER or the music toggle), so it never loads pre-interaction.
