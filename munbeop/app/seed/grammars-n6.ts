...
export const TOPIK_6_GRAMMAR: Grammar[] = [
  ...
  // G258 · For fear that (literary, additional)
  {
    ...
    meaning: L(
      ...
      '"กลัวว่าจะ ... (วรรณกรรม)" — เทียบกับ -(으)ㄹ까 봐',
      '"khawatir kalau-kalau ... (sastrawi)" — versi sastra dari -(으)ㄹ까 봐',
      '"sợ rằng ... (văn chương)" — biến thể văn chương của -(으)ㄹ까 봐',
      '「〜しようかと(文語)」— -(으)ㄹ까 봐 の文語形',
    ),
  ...
  // G289 · Dying of (extreme, complementary)
  {
    ko: '-아/어 죽을 지경이다',
    meaning: L(
      '"on the verge of dying from ..." — fuses -아/어 죽겠다 with -(으)ㄹ 지경이다 for extreme intensity',
      '"al borde de morir de ..." — fusión de -아/어 죽겠다 y -(으)ㄹ 지경이다',
      '«être au point de mourir de ...» — fusion de -아/어 죽겠다 et -(으)ㄹ 지경이다',
      '"a ponto de morrer de ..." — fusão de -아/어 죽겠다 com -(으)ㄹ 지경이다',
      '"แทบจะตายเพราะ ..." — รวม -아/어 죽겠다 + -(으)ㄹ 지경이다',
      '"hampir mati karena ..." — gabungan -아/어 죽겠다 + -(으)ㄹ 지경이다',
      '"sắp chết vì ..." — kết hợp -아/어 죽겠다 + -(으)ㄹ 지경이다',
      '「〜て死にそうな状態だ」(-아/어 죽겠다 + -(으)ㄹ 지경이다 の合成)',
    ),
    example: '더워 죽을 지경이에요.',
    trans: L(
