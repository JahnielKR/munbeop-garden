...
export const TOPIK_5_GRAMMAR: Grammar[] = [
  ...
  // G248 · Counterfactual past (literary, additional)
  {
    ko: '-았/었던들',
    meaning: L(
      '"if (only) one had ..." — literary counterfactual past (cf. -았/었더라면)',
      '"si (solo) hubiera ..." — contrafactual pasado literario (cf. -았/었더라면)',
      '«si seulement on avait ...» — irréel littéraire (cf. -았/었더라면)',
      '"se ao menos tivesse ..." — contrafactual literário (cf. -았/었더라면)',
      '"ถ้าตอนนั้น ... (วรรณกรรม)" — เทียบกับ -았/었더라면',
      '"andai dulu pernah ... (sastrawi)" — bandingkan dengan -았/었더라면',
      '"giá mà đã ... (văn chương)" — so với -았/었더라면',
      '「〜ていたなら(文語)」— -았/었더라면 の文語形',
    ),
  ...
  // G282 · Meant to, but mistakenly (complementary, variant of G184)
  {
    ko: '-(으)ㄴ다는 게',
    meaning: L(
      '"meant to ... but ended up ... (colloquial)" — variant of -ㄴ/는다는 것이',
      '"lo que quería era ... pero al final ... (coloquial)" — variante de -ㄴ/는다는 것이',
      '«je voulais ... mais en fin de compte ... (oral)» — variante de -ㄴ/는다는 것이',
      '"queria ... mas acabei ... (coloquial)" — variante de -ㄴ/는다는 것이',
      '"กะว่าจะ ... แต่ก็ ... (พูด)" — แบบของ -ㄴ/는다는 것이',
      '"niatnya ... malah ... (lisan)" — varian dari -ㄴ/는다는 것이',
      '"định ... mà rốt cuộc ... (nói)" — biến thể của -ㄴ/는다는 것이',
      '「〜するつもりが(口語)」— -ㄴ/는다는 것이 の口語形',
    ),
  ...
  // G283 · Merely (formal emphasis, complementary; variant of G104)
  {
    ko: '-(으)ㄹ 따름입니다',
    meaning: L(
      '"merely / simply ..." in 합쇼체 — formal version of -(으)ㄹ 따름이다',
      '"simplemente / lo único que ..." en 합쇼체 — versión formal de -(으)ㄹ 따름이다',
      '«je ne fais que / il n’y a qu’à ...» (forme 합쇼체 de -(으)ㄹ 따름이다)',
      '"apenas / só faço ..." (forma 합쇼체 de -(으)ㄹ 따름이다)',
      '"เพียงแค่ ... (รูปทางการ 합쇼체 ของ -(으)ㄹ 따름이다)"',
      '"hanya bisa ... (bentuk formal 합쇼체 dari -(으)ㄹ 따름이다)"',
      '"chỉ biết ... (kính ngữ 합쇼체 của -(으)ㄹ 따름이다)"',
      '「〜するばかりです(改まり)」— -(으)ㄹ 따름이다 の합쇼체形',
    ),
