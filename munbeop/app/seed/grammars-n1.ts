...
export const TOPIK_1_GRAMMAR: Grammar[] = [
  ...
  // G001 · Copula
  {
    ...
    usageNotes: L(
      'The noun copula — attaches directly to a noun to mean "to be (something)" (identity / category), NOT location (that\'s 있다). 이다 is the affirmative, 아니다 the negative. Polite forms: 이다 → 이에요 after a consonant (학생이에요), 예요 after a vowel (의자예요); formal -ㅂ니다 form is 입니다. 아니다 is special: it requires the noun to take 이/가 before it (저는 학생이 아니에요 "I am not a student"), unlike 이다 which attaches directly. The formal negative is 아닙니다.',
      'Cópula nominal — se pega directamente a un sustantivo para significar "ser (algo)" (identidad / categoría), NO ubicación (para eso está 있다). 이다 es la afirmativa, 아니다 la negativa. Formas educadas: 이다 → 이에요 tras consonante (학생이에요), 예요 tras vocal (의자예요); la forma formal -ㅂ니다 es 입니다. 아니다 es especial: requiere que el sustantivo lleve 이/가 antes (저는 학생이 아니에요 "no soy estudiante"), a diferencia de 이다 que se pega directo. La negativa formal es 아닙니다.',
      'Copule nominale — s\'attache directement à un nom pour signifier « être (quelque chose) » (identité / catégorie), PAS un emplacement (qui prend 있다). 이다 est l\'affirmatif, 아니다 le négatif. Formes polies : 이다 → 이에요 après consonne (학생이에요), 예요 après voyelle (의자예요) ; la forme formelle -ㅂ니다 est 입니다. 아니다 est spécial : le nom doit prendre 이/가 devant lui (저는 학생이 아니에요 « je ne suis pas étudiant »), contrairement à 이다 qui s\'attache directement. Le négatif formel est 아닙니다.',
      'Cópula nominal — anexa-se diretamente a um substantivo para significar "ser (algo)" (identidade / categoria), NÃO localização (para isso é 있다). 이다 é a afirmativa, 아니다 a negativa. Formas educadas: 이다 → 이에요 depois de consoante (학생이에요), 예요 depois de vogal (의자예요); a forma formal -ㅂ니다 é 입니다. 아니다 é especial: exige que o substantivo leve 이/가 antes (저는 학생이 아니에요 "não sou estudante"), diferente de 이다 que se anexa direto. A negativa formal é 아닙니다.',
      'คำกริยานุเคราะห์ของคำนาม — เกาะติดคำนามโดยตรงเพื่อแปลว่า "เป็น/คือ (อะไรบางอย่าง)" (บอกตัวตน/ประเภท) ไม่ใช่ที่อยู่ (ที่อยู่ใช้ 있다). 이다 รูปบอกเล่า, 아니다 รูปปฏิเสธ. รูปสุภาพ: 이다 → 이에요 หลังพยัญชนะ (학생이에요), 예요 หลังสระ (의자예요); รูปทางการ -ㅂ니다 คือ 입니다. 아니다 พิเศษ: ต้องใส่ 이/가 หลังคำนามก่อน (저는 학생이 아니에요 "ฉันไม่ใช่นักเรียน") ต่างจาก 이다 ที่เกาะติดตรง ๆ. รูปปฏิเสธทางการคือ 아닙니다',
      'Kopula nomina — menempel langsung pada kata benda untuk berarti "menjadi/adalah (sesuatu)" (identitas / kategori), BUKAN lokasi (itu 있다). 이다 bentuk afirmatif, 아니다 negatif. Bentuk sopan: 이다 → 이에요 setelah konsonan (학생이에요), 예요 setelah vokal (의자예요); bentuk formal -ㅂ니다 adalah 입니다. 아니다 istimewa: kata bendanya wajib pakai 이/가 sebelumnya (저는 학생이 아니에요 "saya bukan pelajar"), berbeda dari 이다 yang menempel langsung. Negatif formalnya 아닙니다.',
      'Hệ từ danh từ — gắn thẳng vào danh từ để nghĩa "là (cái gì)" (định danh / phân loại), KHÔNG phải vị trí (vị trí dùng 있다). 이다 dạng khẳng định, 아니다 dạng phủ định. Dạng lịch sự: 이다 → 이에요 sau phụ âm (학생이에요), 예요 sau nguyên âm (의자예요); dạng trang trọng -ㅂ니다 là 입니다. 아니다 đặc biệt: danh từ trước nó phải có 이/가 (저는 학생이 아니에요 "tôi không phải là học sinh"), khác với 이다 gắn trực tiếp. Phủ định trang trọng là 아닙니다.',
      '名詞文の繋辞 — 名詞に直接付いて「〜である」(同定・分類)を表す。所在ではない(所在は 있다)。이다 が肯定、아니다 が否定。丁寧形: 이다 は子音語幹で 이에요(학생이에요)、母音語幹で 예요(의자예요)、フォーマルな -ㅂ니다 形は 입니다。아니다 は特殊で、前の名詞に 이/가 が必要(저는 학생이 아니에요「私は学生ではない」)、이다 のように直接付かない。フォーマルな否定は 아닙니다。',
    ),
    deckId: 'topik-1',
  },
  ...
  // G027 · Existence / possession
  {
    ...
    usageNotes: L(
      'Double-duty verb covering both "to exist / be located" (책상 위에 책이 있어요 "there is a book on the desk") and "to have / possess" (시간이 있어요 "I have time"). 없다 is the matching negative for both senses. The thing existed-or-possessed takes 이/가, NOT 을/를 — 시간이 있어요/없어요, never 시간을. Distinguish from 이다 (noun copula, identity) and from "live/dwell" 살다 (residence). Honorific for people: 있다 → 계시다 (할아버지가 계세요 "grandfather is here / has it"); 없다 → 안 계시다.',
      'Verbo de doble función: "existir / estar (en un lugar)" (책상 위에 책이 있어요 "hay un libro sobre el escritorio") y "tener / poseer" (시간이 있어요 "tengo tiempo"). 없다 es la negativa para ambos sentidos. Lo que existe o se posee lleva 이/가, NUNCA 을/를 — 시간이 있어요/없어요, no 시간을. Distinguilo de 이다 (cópula nominal, identidad) y de 살다 (residir). Honorífico para personas: 있다 → 계시다 (할아버지가 계세요 "el abuelo está/tiene"); 없다 → 안 계시다.',
      'Verbe à double emploi : « exister / se trouver » (책상 위에 책이 있어요 « il y a un livre sur le bureau ») et « avoir / posséder » (시간이 있어요 « j\'ai du temps »). 없다 est le négatif des deux sens. Ce qui existe ou est possédé prend 이/가, PAS 을/를 — 시간이 있어요/없어요, jamais 시간을. À distinguer de 이다 (copule nominale, identité) et de 살다 (résider). Honorifique pour les personnes : 있다 → 계시다 (할아버지가 계세요 « grand-père est là / l\'a ») ; 없다 → 안 계시다.',
      'Verbo de função dupla: "existir / estar (em um lugar)" (책상 위에 책이 있어요 "há um livro sobre a mesa") e "ter / possuir" (시간이 있어요 "tenho tempo"). 없다 é a negativa para ambos os sentidos. O que existe ou é possuído leva 이/가, NUNCA 을/를 — 시간이 있어요/없어요, não 시간을. Distinga de 이다 (cópula nominal, identidade) e de 살다 (residir). Honorífico para pessoas: 있다 → 계시다 (할아버지가 계세요 "o avô está aqui / tem"); 없다 → 안 계시다.',
      'กริยาทำหน้าที่คู่: "มี/อยู่ (ในที่ไหน)" (책상 위에 책이 있어요 "มีหนังสืออยู่บนโต๊ะ") และ "มี/ครอบครอง" (시간이 있어요 "ฉันมีเวลา"). 없다 เป็นรูปปฏิเสธของทั้งสองความหมาย. สิ่งที่มีหรือถูกครอบครองใช้ 이/가 ห้ามใช้ 을/를 — 시간이 있어요/없어요 ไม่ใช่ 시간을. ต่างจาก 이다 (กริยานุเคราะห์, ตัวตน) และจาก 살다 (อาศัย). รูปยกย่องสำหรับคน: 있다 → 계시다 (할아버지가 계세요 "คุณปู่อยู่/มี"), 없다 → 안 계시다',
      'Verba dwifungsi: "ada / berada (di suatu tempat)" (책상 위에 책이 있어요 "ada buku di atas meja") dan "punya / memiliki" (시간이 있어요 "saya punya waktu"). 없다 adalah negatif untuk kedua makna. Yang ada atau dimiliki pakai 이/가, BUKAN 을/를 — 시간이 있어요/없어요, bukan 시간을. Bedakan dari 이다 (kopula nomina, identitas) dan dari 살다 (tinggal). Honorifik untuk orang: 있다 → 계시다 (할아버지가 계세요 "kakek ada / punya"); 없다 → 안 계시다.',
      'Động từ kép: "có / ở (đâu đó)" (책상 위에 책이 있어요 "có quyển sách trên bàn") và "có / sở hữu" (시간이 있어요 "tôi có thời gian"). 없다 là dạng phủ định cho cả hai nghĩa. Vật được tồn tại hay sở hữu đi với 이/가, KHÔNG đi với 을/를 — 시간이 있어요/없어요, không phải 시간을. Phân biệt với 이다 (hệ từ danh từ, định danh) và 살다 (cư trú). Kính ngữ cho người: 있다 → 계시다 (할아버지가 계세요 "ông đang ở đây / có"); 없다 → 안 계시다.',
      '二つの役割を担う動詞: 「存在する／〜にある」(책상 위에 책이 있어요「机の上に本がある」)と「持っている」(시간이 있어요「時間がある」)。없다 は両方の意味の否定。存在する／持っている対象は 이/가 で受け、을/를 ではない — 시간이 있어요/없어요、시간을 とは言わない。이다(名詞繋辞、同定)とも 살다(居住)とも区別する。人に対する尊敬形: 있다 → 계시다(할아버지가 계세요「祖父がいらっしゃる／お持ちだ」)、없다 → 안 계시다。',
    ),
    deckId: 'topik-1',
  },
  ...
  // G028 · Like / dislike (active verb)
  {
    ...
    usageNotes: L(
      'Active verbs of preference: the thing you like takes 을/를 (음악을 좋아해요), not 이/가. Don\'t confuse with the descriptive adjectives 좋다 "to be good/pleasant" and 싫다 "to be unpleasant", which take 이/가 (음악이 좋아요 ≈ "music is great / I find music nice"). Native speakers shift between the two: 좋다/싫다 describe a sensation, 좋아하다/싫어하다 describe an active stance. Past forms: 좋아했어요, 싫어했어요. Tip: if your sentence would translate naturally as "X is nice/awful (to me)", reach for 좋다/싫다; if it\'s "I like/dislike X", reach for 좋아하다/싫어하다.',
      'Verbos activos de preferencia: lo que te gusta lleva 을/를 (음악을 좋아해요), no 이/가. No confundir con los adjetivos descriptivos 좋다 "ser bueno/agradable" y 싫다 "ser desagradable", que llevan 이/가 (음악이 좋아요 ≈ "la música es buena / me parece buena"). Los nativos alternan los dos: 좋다/싫다 describen una sensación, 좋아하다/싫어하다 describen una postura activa. Pasados: 좋아했어요, 싫어했어요. Tip: si la frase suena natural como "X es agradable/horrible (para mí)", usa 좋다/싫다; si es "me gusta/no me gusta X", usa 좋아하다/싫어하다.',
      'Verbes actifs de préférence : ce qu\'on aime prend 을/를 (음악을 좋아해요), pas 이/가. À ne pas confondre avec les adjectifs descriptifs 좋다 « être bon/agréable » et 싫다 « être désagréable », qui prennent 이/가 (음악이 좋아요 ≈ « la musique est super / je la trouve bien »). Les natifs alternent les deux : 좋다/싫다 décrivent une sensation, 좋아하다/싫어하다 une attitude active. Passés : 좋아했어요, 싫어했어요. Astuce : si la phrase passe en « X est agréable/horrible (pour moi) », prendre 좋다/싫다 ; si c\'est « j\'aime / je n\'aime pas X », prendre 좋아하다/싫어하다.',
      'Verbos ativos de preferência: o que você gosta leva 을/를 (음악을 좋아해요), não 이/가. Não confunda com os adjetivos descritivos 좋다 "ser bom/agradável" e 싫다 "ser desagradável", que levam 이/가 (음악이 좋아요 ≈ "música é boa / acho legal"). Nativos alternam os dois: 좋다/싫다 descrevem uma sensação, 좋아하다/싫어하다 descrevem uma postura ativa. Passado: 좋아했어요, 싫어했어요. Dica: se a frase soa natural como "X é agradável/horrível (para mim)", vá de 좋다/싫다; se for "eu gosto/não gosto de X", vá de 좋아하다/싫어하다.',
      'กริยาแสดงความชอบเชิงกระทำ: สิ่งที่ชอบใส่ 을/를 (음악을 좋아해요) ไม่ใช่ 이/가. อย่าสับสนกับคำคุณศัพท์เชิงพรรณนา 좋다 "ดี/น่าพอใจ" และ 싫다 "ไม่ชอบ/ไม่น่าพอใจ" ซึ่งใช้ 이/가 (음악이 좋아요 ≈ "ดนตรีนี้ดี/ฉันชอบ"). คนเกาหลีสลับใช้สองชุดนี้: 좋다/싫다 บอกความรู้สึก ส่วน 좋아하다/싫어하다 บอกท่าทีเชิงกระทำ. รูปอดีต: 좋아했어요, 싫어했어요. เคล็ดลับ: ถ้าประโยคแปลเป็น "X ดี/แย่ (สำหรับฉัน)" ใช้ 좋다/싫다; ถ้าเป็น "ฉันชอบ/ไม่ชอบ X" ใช้ 좋아하다/싫어하다',
      'Verba aktif preferensi: yang disukai pakai 을/를 (음악을 좋아해요), bukan 이/가. Jangan tertukar dengan adjektiva deskriptif 좋다 "bagus/menyenangkan" dan 싫다 "tidak menyenangkan", yang pakai 이/가 (음악이 좋아요 ≈ "musiknya bagus / saya senang"). Penutur asli berganti-ganti: 좋다/싫다 melukiskan rasa, 좋아하다/싫어하다 sikap aktif. Bentuk lampau: 좋아했어요, 싫어했어요. Tips: kalau kalimat terasa wajar sebagai "X bagus/jelek (bagi saya)", pakai 좋다/싫다; kalau "saya suka/tidak suka X", pakai 좋아하다/싫어하다.',
      'Động từ chủ động chỉ sở thích: cái bạn thích đi với 을/를 (음악을 좋아해요), không phải 이/가. Đừng nhầm với tính từ miêu tả 좋다 "tốt/dễ chịu" và 싫다 "khó chịu/ghét", vốn đi với 이/가 (음악이 좋아요 ≈ "âm nhạc tuyệt / tôi thấy hay"). Người Hàn dùng xen kẽ: 좋다/싫다 tả cảm giác, 좋아하다/싫어하다 tả thái độ chủ động. Quá khứ: 좋아했어요, 싫어했어요. Mẹo: nếu câu hợp lý khi dịch "X dễ chịu/khó chịu (với tôi)", dùng 좋다/싫다; nếu là "tôi thích / không thích X", dùng 좋아하다/싫어하다.',
      '能動的な好悪動詞: 好きな対象は 을/를 で受ける(음악을 좋아해요)、이/가 ではない。これと対になる描写形容詞の 좋다「良い／好ましい」と 싫다「いやだ」は 이/가 で受ける(음악이 좋아요 ≈「音楽がいい／私は好き」)。ネイティブはこの二系統を使い分ける: 좋다/싫다 は感覚を描写、좋아하다/싫어하다 は能動的な態度を述べる。過去形: 좋아했어요、싫어했어요。コツ: 「(私にとって)Xは良い／いやだ」と訳して自然なら 좋다/싫다、「Xが好きだ／嫌いだ」と訳して自然なら 좋아하다/싫어하다。',
    ),
    deckId: 'topik-1',
  },
  ...
  // G012 · Present polite ending
  {
    ...
    usageNotes: L(
      "The default polite register (해요체) — used in almost every adult conversation: with strangers, colleagues, anyone slightly older. Pick the vowel by harmony: 아요 if the stem's last vowel is ㅏ or ㅗ (받다 → 받아요), 어요 otherwise (먹다 → 먹어요). Vowel contractions: 가다 → 가요 (not 가아요), 오다 → 와요, 마시다 → 마셔요, 배우다 → 배워요, 되다 → 돼요. 하다 verbs become 해요 (공부하다 → 공부해요). Watch for irregulars: ㅂ-verbs (춥다 → 추워요), ㅡ-elision (바쁘다 → 바빠요, 예쁘다 → 예뻐요), 르-doubling (모르다 → 몰라요, 빠르다 → 빨라요).",
      'El registro educado por defecto (해요체) — el que usás en casi toda conversación adulta: con desconocidos, compañeros de trabajo, alguien apenas mayor. La vocal sale por armonía: 아요 si la última vocal del raíz es ㅏ o ㅗ (받다 → 받아요), 어요 en cualquier otro caso (먹다 → 먹어요). Contracciones de vocales: 가다 → 가요 (no 가아요), 오다 → 와요, 마시다 → 마셔요, 배우다 → 배워요, 되다 → 돼요. Los verbos 하다 → 해요 (공부하다 → 공부해요). Cuidado con irregulares: ㅂ-verbos (춥다 → 추워요), elisión de ㅡ (바쁘다 → 바빠요, 예쁘다 → 예뻐요), doblado 르 (모르다 → 몰라요, 빠르다 → 빨라요).',
      'Le registre poli par défaut (해요체) — celui qu\'on emploie dans presque toute conversation adulte : inconnus, collègues, personne légèrement plus âgée. La voyelle suit l\'harmonie : 아요 si la dernière voyelle de la racine est ㅏ ou ㅗ (받다 → 받아요), 어요 sinon (먹다 → 먹어요). Contractions vocaliques : 가다 → 가요 (et non 가아요), 오다 → 와요, 마시다 → 마셔요, 배우다 → 배워요, 되다 → 돼요. Les verbes en 하다 → 해요 (공부하다 → 공부해요). Attention aux irréguliers : verbes en ㅂ (춥다 → 추워요), élision de ㅡ (바쁘다 → 바빠요, 예쁘다 → 예뻐요), doublement 르 (모르다 → 몰라요, 빠르다 → 빨라요).',
      'O registro educado padrão (해요체) — o que se usa em quase toda conversa adulta: estranhos, colegas, alguém ligeiramente mais velho. A vogal sai por harmonia: 아요 se a última vogal do radical é ㅏ ou ㅗ (받다 → 받아요), 어요 nos outros casos (먹다 → 먹어요). Contrações de vogais: 가다 → 가요 (não 가아요), 오다 → 와요, 마시다 → 마셔요, 배우다 → 배워요, 되다 → 돼요. Verbos em 하다 → 해요 (공부하다 → 공부해요). Cuidado com irregulares: verbos em ㅂ (춥다 → 추워요), elisão de ㅡ (바쁘다 → 바빠요, 예쁘다 → 예뻐요), duplicação 르 (모르다 → 몰라요, 빠르다 → 빨라요).',
      'รูปสุภาพมาตรฐาน (해요체) — ใช้ในการสนทนาผู้ใหญ่เกือบทุกแบบ: คนแปลกหน้า เพื่อนร่วมงาน ผู้ที่อายุมากกว่าเล็กน้อย. เลือกสระตามความกลมกลืน: 아요 ถ้าสระสุดท้ายของรากเป็น ㅏ หรือ ㅗ (받다 → 받아요), 어요 ในกรณีอื่น (먹다 → 먹어요). การหดของสระ: 가다 → 가요 (ไม่ใช่ 가아요), 오다 → 와요, 마시다 → 마셔요, 배우다 → 배워요, 되다 → 돼요. กริยา 하다 → 해요 (공부하다 → 공부해요). ระวังกลุ่มไม่ปกติ: กริยา ㅂ (춥다 → 추워요), การละ ㅡ (바쁘다 → 바빠요, 예쁘다 → 예뻐요), 르 ซ้ำตัว (모르다 → 몰라요, 빠르다 → 빨라요).',
      'Register sopan default (해요체) — yang dipakai di hampir semua percakapan orang dewasa: orang asing, rekan kerja, orang yang sedikit lebih tua. Vokal mengikuti harmoni: 아요 kalau vokal terakhir akar adalah ㅏ atau ㅗ (받다 → 받아요), 어요 selainnya (먹다 → 먹어요). Kontraksi vokal: 가다 → 가요 (bukan 가아요), 오다 → 와요, 마시다 → 마셔요, 배우다 → 배워요, 되다 → 돼요. Verba 하다 → 해요 (공부하다 → 공부해요). Hati-hati pengecualian: verba ㅂ (춥다 → 추워요), elisi ㅡ (바쁘다 → 바빠요, 예쁘다 → 예뻐요), 르 berlipat (모르다 → 몰라요, 빠르다 → 빨라요).',
      'Cấp độ lịch sự mặc định (해요체) — dùng trong gần như mọi hội thoại người lớn: người lạ, đồng nghiệp, người lớn hơn một chút. Nguyên âm theo hài hòa: 아요 nếu nguyên âm cuối của gốc là ㅏ hoặc ㅗ (받다 → 받아요), 어요 trong các trường hợp khác (먹다 → 먹어요). Co rút nguyên âm: 가다 → 가요 (không phải 가아요), 오다 → 와요, 마시다 → 마셔요, 배우다 → 배워요, 되다 → 돼요. Động từ 하다 → 해요 (공부하다 → 공부해요). Lưu ý bất quy tắc: động từ ㅂ (춥다 → 추워요), tỉnh lược ㅡ (바쁘다 → 바빠요, 예쁘다 → 예뻐요), 르 nhân đôi (모르다 → 몰라요, 빠르다 → 빨라요).',
      '日常で最もよく使う丁寧体(해요체) — 知らない人、職場の同僚、少し年上の相手など、ほぼすべての大人の会話で標準。母音は調和規則で選ぶ: 語幹末母音が ㅏ・ㅗ なら 아요(받다 → 받아요)、それ以外は 어요(먹다 → 먹어요)。母音縮約: 가다 → 가요(가아요 ではない)、오다 → 와요、마시다 → 마셔요、배우다 → 배워요、되다 → 돼요。하다 動詞は 해요(공부하다 → 공부해요)。不規則に注意: ㅂ 不規則(춥다 → 추워요)、ㅡ 脱落(바쁘다 → 바빠요、예쁘다 → 예뻐요)、르 二重化(모르다 → 몰라요、빠르다 → 빨라요)。',
    ),
    deckId: 'topik-1',
  },
  ...
  // G013 · Past polite
  {
    ...
    usageNotes: L(
      'Past tense built on top of the -아/어요 stem: same vowel-harmony rule (받다 → 받았어요, 먹다 → 먹었어요) and the same contractions you already know (가다 → 갔어요, 보다 → 봤어요, 마시다 → 마셨어요, 배우다 → 배웠어요, 되다 → 됐어요). 하다 verbs become 했어요. Covers both completed actions (어제 책을 읽었어요 "I read a book yesterday") and resulting states still relevant now (결혼했어요 "I am married" — Korean uses past where English uses present). For the copula 이다, the past is -이었어요/였어요 (학생이었어요, 친구였어요). Formal version: -았/었습니다.',
      'Pasado construido sobre la raíz de -아/어요: misma regla de armonía vocálica (받다 → 받았어요, 먹다 → 먹었어요) y las mismas contracciones que ya conocés (가다 → 갔어요, 보다 → 봤어요, 마시다 → 마셨어요, 배우다 → 배웠어요, 되다 → 됐어요). Los verbos 하다 → 했어요. Cubre tanto acciones completadas (어제 책을 읽었어요 "ayer leí un libro") como estados resultantes todavía vigentes (결혼했어요 "estoy casado/a" — el coreano usa pasado donde el español usa presente). Para la cópula 이다, el pasado es -이었어요/였어요 (학생이었어요, 친구였어요). Versión formal: -았/었습니다.',
      'Passé construit sur la racine de -아/어요 : même règle d\'harmonie vocalique (받다 → 받았어요, 먹다 → 먹었어요) et mêmes contractions déjà connues (가다 → 갔어요, 보다 → 봤어요, 마시다 → 마셨어요, 배우다 → 배웠어요, 되다 → 됐어요). Les verbes en 하다 → 했어요. Couvre les actions accomplies (어제 책을 읽었어요 « hier j\'ai lu un livre ») comme les états résultants encore valables (결혼했어요 « je suis marié(e) » — le coréen emploie le passé là où le français préfère le présent). Pour la copule 이다, le passé est -이었어요/였어요 (학생이었어요, 친구였어요). Version formelle : -았/었습니다.',
      'Passado construído sobre o radical de -아/어요: mesma regra de harmonia vocálica (받다 → 받았어요, 먹다 → 먹었어요) e as mesmas contrações que você já conhece (가다 → 갔어요, 보다 → 봤어요, 마시다 → 마셨어요, 배우다 → 배웠어요, 되다 → 됐어요). Verbos 하다 → 했어요. Cobre tanto ações concluídas (어제 책을 읽었어요 "ontem li um livro") quanto estados resultantes ainda válidos (결혼했어요 "sou casado/a" — coreano usa passado onde português usaria presente). Para a cópula 이다, o passado é -이었어요/였어요 (학생이었어요, 친구였어요). Versão formal: -았/었습니다.',
      'รูปอดีตสร้างจากรากของ -아/어요: ใช้กฎความกลมกลืนของสระเดียวกัน (받다 → 받았어요, 먹다 → 먹었어요) และการหดเหมือนเดิม (가다 → 갔어요, 보다 → 봤어요, 마시다 → 마셨어요, 배우다 → 배웠어요, 되다 → 됐어요). กริยา 하다 → 했어요. ใช้กับการกระทำที่จบแล้ว (어제 책을 읽었어요 "เมื่อวานอ่านหนังสือ") และสภาพผลลัพธ์ที่ยังคงอยู่ (결혼했어요 "ฉันแต่งงานแล้ว" — เกาหลีใช้รูปอดีตในที่ที่ภาษาไทยใช้ปัจจุบัน). สำหรับ 이다 รูปอดีตคือ -이었어요/였어요 (학생이었어요, 친구였어요). รูปทางการ: -았/었습니다',
      'Bentuk lampau dibangun di atas akar -아/어요: aturan harmoni vokal yang sama (받다 → 받았어요, 먹다 → 먹었어요) dan kontraksi yang sama (가다 → 갔어요, 보다 → 봤어요, 마시다 → 마셨어요, 배우다 → 배웠어요, 되다 → 됐어요). Verba 하다 → 했어요. Mencakup aksi yang sudah selesai (어제 책을 읽었어요 "kemarin saya baca buku") dan keadaan hasil yang masih berlaku (결혼했어요 "saya sudah menikah" — Korea memakai lampau di tempat Indonesia memakai bentuk kini). Untuk kopula 이다, lampaunya -이었어요/였어요 (학생이었어요, 친구였어요). Versi formal: -았/었습니다.',
      'Quá khứ xây trên gốc -아/어요: cùng quy tắc hài hòa nguyên âm (받다 → 받았어요, 먹다 → 먹었어요) và cùng các co rút bạn đã biết (가다 → 갔어요, 보다 → 봤어요, 마시다 → 마셨어요, 배우다 → 배웠어요, 되다 → 됐어요). Động từ 하다 → 했어요. Diễn tả cả hành động đã hoàn tất (어제 책을 읽었어요 "hôm qua tôi đã đọc sách") lẫn trạng thái kết quả vẫn còn hiệu lực (결혼했어요 "tôi đã kết hôn / tôi có gia đình" — tiếng Hàn dùng quá khứ ở chỗ tiếng Việt thường dùng hiện tại). Với hệ từ 이다, quá khứ là -이었어요/였어요 (학생이었어요, 친구였어요). Dạng trang trọng: -았/었습니다.',
      '過去形は -아/어요 の語幹に乗せて作る: 同じ母音調和規則(받다 → 받았어요、먹다 → 먹었어요)、同じ縮約(가다 → 갔어요、보다 → 봤어요、마시다 → 마셨어요、배우다 → 배웠어요、되다 → 됐어요)。하다 動詞は 했어요。完了した動作(어제 책을 읽었어요「昨日本を読んだ」)も、現在まで続く結果状態(결혼했어요「結婚している」— 日本語の現在形に当たる)も両方カバーする。繋辞 이다 の過去は -이었어요/였어요(학생이었어요、친구였어요)。フォーマル形: -았/었습니다。',
    ),
    deckId: 'topik-1',
  },
  ...
  // G014 · Future / supposition
  {
    ...
    usageNotes: L(
      'Two meanings the form shares: (1) future intention in 1st person — "I plan to / will" (저는 갈 거예요 "I\'ll go"); (2) supposition about a third party — "they probably will / it must be" (그분이 한국 사람일 거예요 "they\'re probably Korean"). Form: vowel-ending stem → -ㄹ 거예요 (가다 → 갈 거예요); consonant-ending stem → -을 거예요 (먹다 → 먹을 거예요). ㄹ-stems behave like vowel stems (살다 → 살 거예요). Compare neighbors: -(으)ㄹ게요 commits "I\'ll definitely" (a promise to the listener), -겠- is more abrupt or formal future, -(으)ㄹ 것 같다 hedges as "I think / probably". Formal version: -(으)ㄹ 겁니다.',
      'La misma forma tiene dos sentidos: (1) intención futura en 1ª persona — "voy a / pienso" (저는 갈 거예요 "voy a ir"); (2) suposición sobre tercera persona — "probablemente / debe de" (그분이 한국 사람일 거예요 "esa persona probablemente es coreana"). Forma: raíz terminada en vocal → -ㄹ 거예요 (가다 → 갈 거예요); raíz en consonante → -을 거예요 (먹다 → 먹을 거예요). Las raíces en ㄹ se comportan como las en vocal (살다 → 살 거예요). Comparalo con sus parientes: -(으)ㄹ게요 expresa compromiso "voy a, te lo prometo" (al oyente), -겠- es futuro más cortado o formal, -(으)ㄹ 것 같다 matiza "creo que / probablemente". Versión formal: -(으)ㄹ 겁니다.',
      'Une même forme, deux emplois : (1) intention future à la 1ʳᵉ personne — « je vais / je compte » (저는 갈 거예요 « j\'irai ») ; (2) supposition sur un tiers — « probablement / sans doute » (그분이 한국 사람일 거예요 « cette personne doit être coréenne »). Forme : racine en voyelle → -ㄹ 거예요 (가다 → 갈 거예요) ; racine en consonne → -을 거예요 (먹다 → 먹을 거예요). Les racines en ㄹ se comportent comme celles en voyelle (살다 → 살 거예요). À comparer aux voisins : -(으)ㄹ게요 engage le locuteur envers son interlocuteur (« je vais le faire, promis »), -겠- est plus brusque ou formel, -(으)ㄹ 것 같다 nuance en « je crois / sans doute ». Version formelle : -(으)ㄹ 겁니다.',
      'A mesma forma cobre dois sentidos: (1) intenção futura na 1ª pessoa — "vou / pretendo" (저는 갈 거예요 "vou ir"); (2) suposição sobre terceira pessoa — "provavelmente / deve" (그분이 한국 사람일 거예요 "essa pessoa provavelmente é coreana"). Forma: radical em vogal → -ㄹ 거예요 (가다 → 갈 거예요); radical em consoante → -을 거예요 (먹다 → 먹을 거예요). Radicais em ㄹ se comportam como os em vogal (살다 → 살 거예요). Compare com os primos: -(으)ㄹ게요 compromisso "vou fazer, prometo" (com o ouvinte), -겠- futuro mais cortante ou formal, -(으)ㄹ 것 같다 atenua para "acho que / provavelmente". Versão formal: -(으)ㄹ 겁니다.',
      'รูปเดียวสองความหมาย: (1) เจตนาในอนาคต บุรุษที่ 1 — "จะ / ตั้งใจจะ" (저는 갈 거예요 "ฉันจะไป"); (2) การคาดเดาเกี่ยวกับบุรุษที่ 3 — "คงจะ / น่าจะ" (그분이 한국 사람일 거예요 "เขาน่าจะเป็นคนเกาหลี"). รูป: ราก末สระ → -ㄹ 거예요 (가다 → 갈 거예요); ราก末พยัญชนะ → -을 거예요 (먹다 → 먹을 거예요). รากที่ลงท้าย ㄹ ปฏิบัติเหมือนลงสระ (살다 → 살 거예요). เทียบกับเพื่อนบ้าน: -(으)ㄹ게요 คือคำมั่น "จะทำให้ดู" (กับผู้ฟัง), -겠- เป็นอนาคตที่ห้วน/ทางการกว่า, -(으)ㄹ 것 같다 เป็น "คิดว่า / น่าจะ" แบบเลี่ยง. รูปทางการ: -(으)ㄹ 겁니다',
      'Satu bentuk, dua makna: (1) niat masa depan orang pertama — "akan / berencana" (저는 갈 거예요 "saya akan pergi"); (2) dugaan tentang orang ketiga — "mungkin / kira-kira" (그분이 한국 사람일 거예요 "dia mungkin orang Korea"). Bentuk: akar berakhir vokal → -ㄹ 거예요 (가다 → 갈 거예요); akar berakhir konsonan → -을 거예요 (먹다 → 먹을 거예요). Akar ㄹ berperilaku seperti vokal (살다 → 살 거예요). Bandingkan dengan tetangga: -(으)ㄹ게요 janji "saya akan, pasti" (kepada lawan bicara), -겠- masa depan lebih ringkas/formal, -(으)ㄹ 것 같다 melembutkan jadi "saya pikir / mungkin". Versi formal: -(으)ㄹ 겁니다.',
      'Cùng một dạng có hai nghĩa: (1) dự định tương lai ngôi thứ nhất — "sẽ / dự định" (저는 갈 거예요 "tôi sẽ đi"); (2) suy đoán về ngôi thứ ba — "chắc / hẳn là" (그분이 한국 사람일 거예요 "người đó chắc là người Hàn"). Hình thức: gốc kết nguyên âm → -ㄹ 거예요 (가다 → 갈 거예요); gốc kết phụ âm → -을 거예요 (먹다 → 먹을 거예요). Gốc ㄹ hành xử như gốc nguyên âm (살다 → 살 거예요). So với hàng xóm: -(으)ㄹ게요 cam kết "tôi sẽ, hứa đó" (với người nghe), -겠- tương lai dứt khoát/trang trọng hơn, -(으)ㄹ 것 같다 giảm nhẹ thành "tôi nghĩ / có lẽ". Dạng trang trọng: -(으)ㄹ 겁니다.',
      '一つの形で二つの意味: (1) 一人称の意志・予定 — 「〜するつもり／〜する」(저는 갈 거예요「行きます」); (2) 三人称への推量 — 「たぶん〜だろう／〜のはずだ」(그분이 한국 사람일 거예요「あの方は韓国人でしょう」)。形: 母音語幹 → -ㄹ 거예요(가다 → 갈 거예요)、子音語幹 → -을 거예요(먹다 → 먹을 거예요)。ㄹ 語幹は母音語幹と同じ扱い(살다 → 살 거예요)。仲間との対比: -(으)ㄹ게요 は聞き手への約束「〜しますね」、-겠- はより硬い／改まった未来、-(으)ㄹ 것 같다 は「〜だと思う／たぶん〜」と婉曲化する。フォーマル: -(으)ㄹ 겁니다。',
    ),
    deckId: 'topik-1',
  },
  ...
  // G139 · Formal ending
  {
    ...
    usageNotes: L(
      'The high-formality register (합쇼체) — news broadcasts, presentations, first-meeting business, customer service, military, public announcements. Form: vowel-ending or ㄹ-ending stem → -ㅂ니다 (가다 → 갑니다, 살다 → 삽니다 with ㄹ dropping); consonant-ending stem → -습니다 (먹다 → 먹습니다). Question form: -ㅂ/습니까? (먹습니까? "do you eat?"). Past: -았/었습니다 (갔습니다). Compared with -아/어요 (also polite), -ㅂ/습니다 is more impersonal and authoritative — a news anchor uses -습니다; you and a colleague at lunch use -아/어요. Native speakers code-switch between them sentence by sentence to control distance.',
      'El registro de alta formalidad (합쇼체) — noticieros, presentaciones, primera reunión de negocios, atención al cliente, militar, anuncios públicos. Forma: raíz en vocal o en ㄹ → -ㅂ니다 (가다 → 갑니다, 살다 → 삽니다 con ㄹ que cae); raíz en consonante → -습니다 (먹다 → 먹습니다). Forma interrogativa: -ㅂ/습니까? (먹습니까? "¿come?"). Pasado: -았/었습니다 (갔습니다). Comparado con -아/어요 (también educado), -ㅂ/습니다 suena más impersonal y autoritario — un periodista usa -습니다; vos con un colega almorzando usás -아/어요. Los nativos alternan entre los dos oración por oración para controlar la distancia.',
      'Le registre de haute formalité (합쇼체) — journaux télévisés, présentations, première rencontre professionnelle, service clientèle, armée, annonces publiques. Forme : racine en voyelle ou en ㄹ → -ㅂ니다 (가다 → 갑니다, 살다 → 삽니다 avec chute du ㄹ) ; racine en consonne → -습니다 (먹다 → 먹습니다). Interrogatif : -ㅂ/습니까? (먹습니까? « mangez-vous ? »). Passé : -았/었습니다 (갔습니다). Comparé à -아/어요 (poli également), -ㅂ/습니다 sonne plus impersonnel et autoritaire — un présentateur utilise -습니다 ; vous et un collègue à la cantine utilisez -아/어요. Les natifs alternent les deux phrase par phrase pour gérer la distance.',
      'O registro de alta formalidade (합쇼체) — telejornais, apresentações, primeira reunião de negócios, atendimento ao cliente, militar, avisos públicos. Forma: radical em vogal ou em ㄹ → -ㅂ니다 (가다 → 갑니다, 살다 → 삽니다 com ㄹ caindo); radical em consoante → -습니다 (먹다 → 먹습니다). Interrogativa: -ㅂ/습니까? (먹습니까? "você come?"). Passado: -았/었습니다 (갔습니다). Comparado com -아/어요 (também educado), -ㅂ/습니다 soa mais impessoal e autoritário — um jornalista usa -습니다; você e um colega almoçando usam -아/어요. Os nativos alternam frase a frase para regular a distância.',
      'รูปทางการระดับสูง (합쇼체) — รายการข่าว การนำเสนอ การประชุมแรกพบ บริการลูกค้า ทหาร ประกาศสาธารณะ. รูป: รากลงสระหรือ ㄹ → -ㅂ니다 (가다 → 갑니다, 살다 → 삽니다 ㄹ หล่น); รากลงพยัญชนะ → -습니다 (먹다 → 먹습니다). รูปคำถาม: -ㅂ/습니까? (먹습니까? "ทานไหมครับ?"). อดีต: -았/었습니다 (갔습니다). เทียบกับ -아/어요 (สุภาพเหมือนกัน), -ㅂ/습니다 ฟังดูเป็นทางการ ไม่ใช่ส่วนตัว และมีน้ำหนัก — ผู้ประกาศข่าวใช้ -습니다 ส่วนคุณกับเพื่อนร่วมงานตอนเที่ยงใช้ -아/어요. คนเกาหลีสลับใช้สองรูปประโยคต่อประโยคเพื่อควบคุมระยะห่าง',
      'Register sangat formal (합쇼체) — siaran berita, presentasi, pertemuan bisnis pertama, layanan pelanggan, militer, pengumuman publik. Bentuk: akar berakhir vokal atau ㄹ → -ㅂ니다 (가다 → 갑니다, 살다 → 삽니다 dengan ㄹ jatuh); akar berakhir konsonan → -습니다 (먹다 → 먹습니다). Bentuk tanya: -ㅂ/습니까? (먹습니까? "apakah Anda makan?"). Lampau: -았/었습니다 (갔습니다). Dibanding -아/어요 (juga sopan), -ㅂ/습니다 terdengar lebih impersonal dan berwibawa — pembawa berita memakai -습니다; Anda dan kolega saat makan siang pakai -아/어요. Penutur asli berganti antara keduanya tiap kalimat untuk mengatur jarak.',
      'Cấp độ cực kỳ trang trọng (합쇼체) — bản tin, thuyết trình, cuộc gặp kinh doanh đầu tiên, chăm sóc khách hàng, quân đội, thông báo công cộng. Hình thức: gốc kết nguyên âm hoặc ㄹ → -ㅂ니다 (가다 → 갑니다, 살다 → 삽니다 với ㄹ rụng); gốc kết phụ âm → -습니다 (먹다 → 먹습니다). Dạng hỏi: -ㅂ/습니까? (먹습니까? "bạn ăn không?"). Quá khứ: -았/었습니다 (갔습니다). So với -아/어요 (cũng lịch sự), -ㅂ/습니다 nghe trang nghiêm, không cá nhân hơn — phát thanh viên dùng -습니다, còn bạn và đồng nghiệp ăn trưa dùng -아/어요. Người Hàn chuyển đổi giữa hai dạng câu này sang câu khác để điều chỉnh khoảng cách.',
      '高フォーマルの語尾(합쇼체) — ニュース、プレゼン、初対面のビジネス、接客、軍隊、公的アナウンスで用いる。形: 母音または ㄹ 語幹 → -ㅂ니다(가다 → 갑니다、살다 → 삽니다 で ㄹ が脱落); 子音語幹 → -습니다(먹다 → 먹습니다)。疑問形: -ㅂ/습니까?(먹습니까?「召し上がりますか」)。過去: -았/었습니다(갔습니다)。同じ丁寧体の -아/어요 と比べると、-ㅂ/습니다 はより非個人的で重い — ニュースキャスターは -습니다、同僚との昼食では -아/어요。ネイティブは距離感を調整するため、文ごとにこの二つを切り替える。',
    ),
    deckId: 'topik-1',
  },
