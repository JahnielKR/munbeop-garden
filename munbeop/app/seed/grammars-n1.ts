...
export const TOPIK_1_GRAMMAR: Grammar[] = [
  ...
  // G002 · Topic marker
  {
    ...
    usageNotes: L(
      'Marks the topic of the sentence — what you\'re going to talk about ("as for X...").\n\nForm: 은 after a consonant (저는), 는 after a vowel (어머니는).\n\nDon\'t confuse with 이/가. 은/는 introduces something known or general; 이/가 highlights new info or answers "who?/what?".\n\nIn casual speech the particle is often dropped when the topic is obvious.',
      'Marca el tema de la frase — aquello sobre lo que vas a decir algo ("en cuanto a X...").\n\nForma: 은 tras consonante (저는), 는 tras vocal (어머니는).\n\nOjo, no la mezcles con 이/가. 은/는 introduce algo general o ya sabido; 이/가 destaca info nueva o responde a "¿quién?/¿qué?".\n\nEn habla coloquial la partícula se omite cuando el tema queda claro.',
      'Marque le thème de la phrase — ce dont on va parler (« quant à X... »).\n\nForme : 은 après consonne (저는), 는 après voyelle (어머니는).\n\nÀ ne pas confondre avec 이/가. 은/는 introduit une info générale ou déjà connue ; 이/가 met en relief une info nouvelle ou répond à « qui ? / quoi ? ».\n\nÀ l\'oral familier, la particule tombe souvent lorsque le thème est évident.',
      'Marca o tópico da frase — aquilo sobre o que você vai falar ("quanto a X...").\n\nForma: 은 depois de consoante (저는), 는 depois de vogal (어머니는).\n\nNão confunda com 이/가. 은/는 introduz algo geral ou já conhecido; 이/가 destaca info nova ou responde "quem?/o quê?".\n\nNa fala casual a partícula costuma cair quando o tópico está claro.',
      'แสดงหัวเรื่องของประโยค — สิ่งที่กำลังจะพูดถึง ("สำหรับ X...")\n\nรูป: 은 หลังพยัญชนะ (저는), 는 หลังสระ (어머니는)\n\nอย่าสับสนกับ 이/가. 은/는 แนะนำข้อมูลทั่วไปหรือที่รู้กันอยู่แล้ว ส่วน 이/가 เน้นข้อมูลใหม่หรือใช้ตอบ "ใคร?/อะไร?"\n\nในภาษาพูดอย่างกันเอง อนุภาคนี้มักถูกตัดออกเมื่อหัวเรื่องชัดเจนอยู่แล้ว',
      'Menandai topik kalimat — apa yang akan dibicarakan ("mengenai X...").\n\nBentuk: 은 setelah konsonan (저는), 는 setelah vokal (어머니는).\n\nJangan tertukar dengan 이/가. 은/는 memperkenalkan informasi umum atau yang sudah diketahui; 이/가 menekankan info baru atau menjawab "siapa?/apa?".\n\nDalam percakapan santai, partikel ini sering dilepas saat topiknya sudah jelas.',
      'Đánh dấu chủ đề của câu — điều bạn sắp nói tới ("về phần X...").\n\nHình thức: 은 sau phụ âm (저는), 는 sau nguyên âm (어머니는).\n\nĐừng nhầm với 이/가. 은/는 giới thiệu thông tin chung hoặc đã biết; 이/가 làm nổi bật thông tin mới hoặc trả lời "ai?/cái gì?".\n\nTrong khẩu ngữ thân mật, tiểu từ này thường được bỏ khi chủ đề đã rõ.',
      '文の主題を示す（「Xについて言えば」）。\n\n形: 子音の後は 은（저는）、母音の後は 는（어머니는）。\n\n이/가 と混同しないこと。은/는 は既知や一般的な情報を提示するのに対し、이/가 は新情報を際立たせたり「誰が／何が？」に答えたりする。\n\nくだけた会話では、主題が明らかなときに省略されることがある。',
    ),
    deckId: 'topik-1',
  },
