...
export const TOPIK_2_GRAMMAR: Grammar[] = [
  ...
  // G045 · Because (imperative ok, past ok)
  {
    ...
    usageNotes: L(
      'Marks subjective cause — "because / since (in my view)". Form: vowel/ㄹ stem → -니까 (가다 → 가니까, 살다 → 사니까 with ㄹ dropping); consonant stem → -으니까 (먹다 → 먹으니까). Past goes inside: -았/었으니까 (먹었으니까 "since I ate"). Native speakers very often shorten -으니까 to -니까 in casual contexts — both are correct.\n\nThe critical contrast with -아/어서 (the TOPIK-1 "because"): -(으)니까 ALLOWS commands and suggestions in the second clause; -아/어서 BLOCKS them. ✓ 비가 오니까 우산을 가져가세요 "since it\'s raining, take an umbrella"; ✗ 비가 와서 우산을 가져가세요. Past tense also lives easily on -(으)니까 (어제 늦었으니까 오늘 일찍 자세요), while -아/어서 typically leaves past in the second clause. -(으)니까 also has a stronger "I\'m giving you my reason" personal flavor; for objective neutral cause, prefer -아/어서. Use cues: see an imperative, suggestion, or past in the first clause → reach for -(으)니까.',
      'Marca causa subjetiva — "porque / ya que (según yo)". Forma: raíz en vocal/ㄹ → -니까 (가다 → 가니까, 살다 → 사니까 con ㄹ que cae); raíz en consonante → -으니까 (먹다 → 먹으니까). El pasado va adentro: -았/었으니까 (먹었으니까 "ya que comí"). Los nativos suelen acortar -으니까 a -니까 en contextos informales — ambos son correctos.\n\nContraste crítico con -아/어서 (el "porque" de TOPIK 1): -(으)니까 PERMITE órdenes y sugerencias en la 2ª cláusula; -아/어서 las BLOQUEA. ✓ 비가 오니까 우산을 가져가세요 "como llueve, llevá paraguas"; ✗ 비가 와서 우산을 가져가세요. El pasado también convive bien con -(으)니까 (어제 늦었으니까 오늘 일찍 자세요 "como ayer se hizo tarde, dormí temprano hoy"), mientras que -아/어서 normalmente deja el pasado en la 2ª cláusula. -(으)니까 también tiene un sabor más fuerte de "te doy mi razón"; para causas neutras u objetivas usá -아/어서. Pistas: si ves imperativo, sugerencia o pasado en la 1ª cláusula → andá con -(으)니까.',
      'Marque la cause subjective — « parce que / puisque (selon moi) ». Forme : racine en voyelle/ㄹ → -니까 (가다 → 가니까, 살다 → 사니까 avec chute du ㄹ) ; racine en consonne → -으니까 (먹다 → 먹으니까). Le passé se loge à l\'intérieur : -았/었으니까 (먹었으니까 « comme j\'ai mangé »). Les locuteurs natifs raccourcissent souvent -으니까 en -니까 dans des contextes informels — les deux sont corrects.\n\nContraste crucial avec -아/어서 (le « parce que » de TOPIK 1) : -(으)니까 AUTORISE impératif et suggestion en 2ᵉ proposition, alors que -아/어서 les INTERDIT. ✓ 비가 오니까 우산을 가져가세요 « comme il pleut, prends un parapluie » ; ✗ 비가 와서 우산을 가져가세요. Le passé cohabite aussi bien avec -(으)니까 (어제 늦었으니까 오늘 일찍 자세요 « comme tu t\'es couché tard hier, couche-toi tôt ce soir »), tandis que -아/어서 laisse en général le passé dans la 2ᵉ proposition. -(으)니까 a aussi un parfum plus marqué de « je t\'expose ma raison » ; pour une cause neutre / objective, on préfère -아/어서. Repères : un impératif, une suggestion ou un passé en 1ʳᵉ proposition → on prend -(으)니까.',
      'Marca causa subjetiva — "porque / já que (na minha visão)". Forma: radical em vogal/ㄹ → -니까 (가다 → 가니까, 살다 → 사니까 com ㄹ caindo); radical em consoante → -으니까 (먹다 → 먹으니까). O passado vai dentro: -았/었으니까 (먹었으니까 "já que comi"). Os nativos costumam encurtar -으니까 para -니까 em contextos casuais — ambos são corretos.\n\nContraste crucial com -아/어서 (o "porque" do TOPIK 1): -(으)니까 PERMITE ordens e sugestões na 2ª oração; -아/어서 as BLOQUEIA. ✓ 비가 오니까 우산을 가져가세요 "como está chovendo, leve um guarda-chuva"; ✗ 비가 와서 우산을 가져가세요. O passado também convive bem com -(으)니까 (어제 늦었으니까 오늘 일찍 자세요 "como ontem foi tarde, durma cedo hoje"), enquanto -아/어서 normalmente deixa o passado na 2ª oração. -(으)니까 também tem um sabor mais forte de "vou te dar meu motivo"; para causas neutras/objetivas use -아/어서. Pistas: se ver imperativo, sugestão ou passado na 1ª oração → vá com -(으)니까.',
      'แสดงเหตุผลเชิงอัตวิสัย — "เพราะว่า / เนื่องจาก (ในมุมของฉัน)". รูป: รากลงสระ/ㄹ → -니까 (가다 → 가니까, 살다 → 사니까 ㄹ หล่น); รากลงพยัญชนะ → -으니까 (먹다 → 먹으니까). อดีตอยู่ในตัว: -았/었으니까 (먹었으니까 "เพราะว่ากินไปแล้ว"). เจ้าของภาษามักย่อ -으니까 เป็น -니까 ในการพูดทั่วไป — ใช้ได้ทั้งสองแบบ\n\nความต่างสำคัญกับ -아/어서 (รูป "เพราะ" จาก TOPIK 1): -(으)니까 "อนุญาต" คำสั่งหรือชวนในประโยคหลัง ส่วน -아/어서 "ห้าม". ✓ 비가 오니까 우산을 가져가세요 "ฝนตก เอาร่มไปด้วยนะ"; ✗ 비가 와서 우산을 가져가세요. อดีตอยู่ใน -(으)니까 ได้สบาย (어제 늦었으니까 오늘 일찍 자세요 "เมื่อวานเข้านอนดึก คืนนี้นอนเร็ว ๆ นะ") ขณะที่ -아/어서 มักวางอดีตในประโยคหลัง. -(으)니까 ยังมีความรู้สึก "ฉันบอกเหตุผลของฉันให้คุณฟัง" ชัดกว่า; ถ้าเหตุผลเป็นกลาง/ภาวะวัตถุวิสัย เลือก -아/어서. เคล็ดดู: ถ้าเห็นคำสั่ง คำชวน หรืออดีตในประโยคแรก → ใช้ -(으)니까',
      'Menandai sebab subjektif — "karena / sebab (menurut saya)". Bentuk: akar vokal/ㄹ → -니까 (가다 → 가니까, 살다 → 사니까 dengan ㄹ jatuh); akar konsonan → -으니까 (먹다 → 먹으니까). Lampau di dalam: -았/었으니까 (먹었으니까 "karena saya sudah makan"). Penutur asli sering memendekkan -으니까 menjadi -니까 di konteks santai — keduanya benar.\n\nKontras kunci dengan -아/어서 (penanda "karena" TOPIK 1): -(으)니까 MEMBOLEHKAN perintah dan ajakan di klausa kedua; -아/어서 MENOLAKnya. ✓ 비가 오니까 우산을 가져가세요 "karena hujan, bawa payung ya"; ✗ 비가 와서 우산을 가져가세요. Lampau juga nyaman pakai -(으)니까 (어제 늦었으니까 오늘 일찍 자세요 "karena kemarin telat, hari ini tidur cepat ya"), sedangkan -아/어서 biasanya menyimpan lampau di klausa kedua. -(으)니까 juga lebih bernada "saya kasih alasanku"; untuk sebab netral/objektif pilih -아/어서. Petunjuk: ada imperatif, ajakan, atau lampau di klausa pertama → pakai -(으)니까.',
      'Đánh dấu nguyên nhân chủ quan — "vì / bởi vì (theo tôi)". Hình thức: gốc nguyên âm/ㄹ → -니까 (가다 → 가니까, 살다 → 사니까 ㄹ rụng); gốc phụ âm → -으니까 (먹다 → 먹으니까). Quá khứ nằm bên trong: -았/었으니까 (먹었으니까 "vì đã ăn rồi"). Người bản ngữ rất hay rút gọn -으니까 thành -니까 trong khẩu ngữ — cả hai đều đúng.\n\nĐiểm tương phản quan trọng với -아/어서 (cấu trúc "vì" của TOPIK 1): -(으)니까 CHO PHÉP mệnh lệnh và đề nghị ở vế hai; -아/어서 thì CẤM. ✓ 비가 오니까 우산을 가져가세요 "trời mưa nên hãy mang ô"; ✗ 비가 와서 우산을 가져가세요. Quá khứ cũng đứng thoải mái trong -(으)니까 (어제 늦었으니까 오늘 일찍 자세요 "vì hôm qua đi ngủ muộn, hôm nay đi ngủ sớm nhé") trong khi -아/어서 thường để quá khứ ở vế hai. -(으)니까 còn có vị "tôi đưa lý do của tôi" rõ hơn; với nguyên nhân trung tính/khách quan chọn -아/어서. Gợi ý: thấy mệnh lệnh, đề nghị hay quá khứ ở vế đầu → chọn -(으)니까.',
      '主観的な理由を表す「〜から／〜ので(私から見て)」。形: 母音または ㄹ 語幹 → -니까(가다 → 가니까、살다 → 사니까 で ㄹ 脱落); 子音語幹 → -으니까(먹다 → 먹으니까)。過去は中に入る: -았/었으니까(먹었으니까「食べたから」)。ネイティブはカジュアルな場面で -으니까 を -니까 に短縮することが多い — どちらも正しい。\n\nTOPIK 1 の -아/어서(「〜て・〜ので」)との重要な対比: -(으)니까 は後節に命令・勧誘・依頼を「許す」が、-아/어서 は「許さない」。 ✓ 비가 오니까 우산을 가져가세요「雨が降っているから傘を持って行ってください」、✗ 비가 와서 우산을 가져가세요。過去形も -(으)니까 と相性がよい(어제 늦었으니까 오늘 일찍 자세요「昨日は遅かったから今日は早く寝てください」)が、-아/어서 は通常、過去を後節に置く。-(으)니까 は「私の理由はこうです」という主観的なニュアンスが強い; 中立的・客観的な原因には -아/어서。判断材料: 前節に命令・勧誘・過去が見えたら -(으)니까 を選ぶ。',
    ),
    deckId: 'topik-2',
  },
  ...
  // G055 · Because of (formal/strong)
  {
    ...
    usageNotes: L(
      'Stronger, more formal way to say "because of / due to". Two formats: with a noun → N + 때문에 (비 때문에 "because of the rain", 너 때문에 "because of you"); with a verb / adjective → V + -기 때문에 (비가 오기 때문에 "because it\'s raining", 바쁘기 때문에 "because I\'m busy"). The 때문 noun literally means "reason / cause", so the whole pattern reads as "by reason of X".\n\nTone is heavier and more declarative than the conversational -아/어서 or -(으)니까. -기 때문에 cannot take imperatives or suggestions in the second clause (✗ 비가 오기 때문에 우산을 가져가세요 sounds wrong → use -(으)니까). Past goes inside: -았/었기 때문에 (늦었기 때문에 "because I was late"). When N + 때문에 is paired with negative outcomes — failures, blame, missed chances — it carries a "fault" flavor (너 때문에 늦었어 "I\'m late because of you / it\'s your fault"). To soften that and shift to "thanks to" use 덕분에 instead (선생님 덕분에 "thanks to the teacher").',
      'Forma más fuerte y formal de decir "a causa de / debido a". Dos formatos: con sustantivo → N + 때문에 (비 때문에 "por la lluvia", 너 때문에 "por vos"); con verbo / adjetivo → V + -기 때문에 (비가 오기 때문에 "porque llueve", 바쁘기 때문에 "porque estoy ocupado"). El sustantivo 때문 significa literalmente "razón / causa", así que el patrón se lee como "por razón de X".\n\nEl tono es más pesado y declarativo que el conversacional -아/어서 o -(으)니까. -기 때문에 no admite imperativos ni sugerencias en la 2ª cláusula (✗ 비가 오기 때문에 우산을 가져가세요 suena raro → usá -(으)니까). El pasado va adentro: -았/었기 때문에 (늦었기 때문에 "porque me retrasé"). Cuando N + 때문에 se combina con resultados negativos — fracasos, reproches, oportunidades perdidas — toma un sabor de "culpa" (너 때문에 늦었어 "llegué tarde por vos / es culpa tuya"). Para suavizarlo y pasar a "gracias a" usá 덕분에 (선생님 덕분에 "gracias al profe").',
      'Manière plus forte et plus formelle de dire « à cause de / en raison de ». Deux schémas : avec un nom → N + 때문에 (비 때문에 « à cause de la pluie », 너 때문에 « à cause de toi ») ; avec un verbe / adjectif → V + -기 때문에 (비가 오기 때문에 « parce qu\'il pleut », 바쁘기 때문에 « parce que je suis occupé »). Le nom 때문 signifie littéralement « cause / raison », d\'où la lecture « en raison de X ».\n\nLe ton est plus lourd et plus déclaratif que les conversationnels -아/어서 ou -(으)니까. -기 때문에 ne tolère pas d\'impératif ni de suggestion en 2ᵉ proposition (✗ 비가 오기 때문에 우산을 가져가세요 sonne mal → utiliser -(으)니까). Le passé se loge à l\'intérieur : -았/었기 때문에 (늦었기 때문에 « parce que j\'étais en retard »). Quand N + 때문에 est associé à des conséquences négatives — échec, reproche, occasion manquée —, il prend une nuance de « faute » (너 때문에 늦었어 « je suis en retard à cause de toi / c\'est de ta faute »). Pour adoucir et passer à « grâce à », employer 덕분에 (선생님 덕분에 « grâce au professeur »).',
      'Maneira mais forte e formal de dizer "por causa de / devido a". Dois formatos: com substantivo → N + 때문에 (비 때문에 "por causa da chuva", 너 때문에 "por sua causa"); com verbo / adjetivo → V + -기 때문에 (비가 오기 때문에 "porque está chovendo", 바쁘기 때문에 "porque estou ocupado"). O substantivo 때문 literalmente significa "razão / causa", então o padrão lê-se como "pela razão de X".\n\nO tom é mais pesado e declarativo que os conversacionais -아/어서 ou -(으)니까. -기 때문에 não aceita imperativos nem sugestões na 2ª oração (✗ 비가 오기 때문에 우산을 가져가세요 soa estranho → use -(으)니까). O passado vai dentro: -았/었기 때문에 (늦었기 때문에 "porque me atrasei"). Quando N + 때문에 se combina com resultados negativos — fracassos, culpas, oportunidades perdidas — assume um sabor de "culpa" (너 때문에 늦었어 "cheguei tarde por sua causa / a culpa é sua"). Para suavizar e passar a "graças a" use 덕분에 (선생님 덕분에 "graças ao professor").',
      'รูปบอกเหตุที่หนักและทางการกว่า — "เพราะ / เนื่องด้วย". มีสองรูปแบบ: คู่กับคำนาม → N + 때문에 (비 때문에 "เพราะฝน", 너 때문에 "เพราะเธอ"); คู่กับกริยา/คำคุณศัพท์ → V + -기 때문에 (비가 오기 때문에 "เพราะฝนตก", 바쁘기 때문에 "เพราะยุ่ง"). คำนาม 때문 แปลตามตัวอักษรว่า "เหตุ / สาเหตุ" รูปทั้งหมดจึงอ่านได้ว่า "ด้วยสาเหตุของ X"\n\nน้ำเสียงหนักและบอกเล่าชัดกว่า -아/어서 หรือ -(으)니까 ในบทสนทนา. -기 때문에 "ไม่อนุญาต" คำสั่งหรือชวนในประโยคหลัง (✗ 비가 오기 때문에 우산을 가져가세요 ผิด → ใช้ -(으)니까). อดีตอยู่ในตัว: -았/었기 때문에 (늦었기 때문에 "เพราะมาสาย"). เมื่อ N + 때문에 มาคู่กับผลลบ — ล้มเหลว ตำหนิ พลาดโอกาส — จะมีกลิ่น "ความผิด" (너 때문에 늦었어 "ฉันมาสายเพราะเธอ / เป็นความผิดเธอ"). ถ้าจะนุ่มลงเป็น "ต้องขอบคุณ" ใช้ 덕분에 แทน (선생님 덕분에 "ต้องขอบคุณอาจารย์")',
      'Cara yang lebih kuat dan formal untuk berkata "karena / akibat dari". Dua format: dengan kata benda → N + 때문에 (비 때문에 "karena hujan", 너 때문에 "karena kamu"); dengan verba / adjektiva → V + -기 때문에 (비가 오기 때문에 "karena hujan", 바쁘기 때문에 "karena sibuk"). Kata benda 때문 secara harfiah berarti "sebab / alasan", jadi keseluruhannya berbunyi "dengan alasan X".\n\nNada lebih berat dan deklaratif dibanding -아/어서 atau -(으)니까 yang percakapan. -기 때문에 tidak menerima imperatif atau ajakan di klausa kedua (✗ 비가 오기 때문에 우산을 가져가세요 terdengar salah → gunakan -(으)니까). Lampau di dalam: -았/었기 때문에 (늦었기 때문에 "karena saya terlambat"). Saat N + 때문에 dipadukan dengan hasil negatif — kegagalan, tudingan, peluang yang hilang — muncul nuansa "salahnya" (너 때문에 늦었어 "saya telat karena kamu / salahmu"). Untuk melunakkannya menjadi "berkat" pakai 덕분에 (선생님 덕분에 "berkat guru").',
      'Cách nói nguyên nhân mạnh hơn và trang trọng hơn — "vì / do". Hai khuôn: với danh từ → N + 때문에 (비 때문에 "vì mưa", 너 때문에 "vì bạn"); với động từ / tính từ → V + -기 때문에 (비가 오기 때문에 "vì trời mưa", 바쁘기 때문에 "vì bận"). Danh từ 때문 nghĩa đen là "lý do / nguyên nhân", nên cấu trúc đọc thành "vì lý do X".\n\nGiọng nặng và mang tính tuyên bố hơn so với -아/어서 hay -(으)니까 thuộc khẩu ngữ. -기 때문에 không nhận mệnh lệnh hay đề nghị ở vế hai (✗ 비가 오기 때문에 우산을 가져가세요 nghe sai → dùng -(으)니까). Quá khứ nằm bên trong: -았/었기 때문에 (늦었기 때문에 "vì tôi đến muộn"). Khi N + 때문에 đi cùng kết quả tiêu cực — thất bại, trách móc, lỡ cơ hội — mang vị "lỗi của" (너 때문에 늦었어 "tôi muộn vì bạn / là tại bạn"). Muốn nhẹ đi và chuyển thành "nhờ" thì dùng 덕분에 (선생님 덕분에 "nhờ thầy").',
      '原因をより重く・改まって述べる「〜のため／〜のせいで／〜のおかげで」。二つの形: 名詞と組む → N + 때문에(비 때문에「雨のため」、너 때문에「君のせいで」); 動詞・形容詞と組む → V + -기 때문에(비가 오기 때문에「雨が降っているので」、바쁘기 때문에「忙しいので」)。名詞 때문 が「原因・理由」を意味するので、全体は「Xという理由で」と読める。\n\nトーンは会話的な -아/어서 や -(으)니까 より重く、宣言的。-기 때문에 は後節に命令・勧誘を取れない(✗ 비가 오기 때문에 우산을 가져가세요 は不自然 → -(으)니까 を使う)。過去は中に入る: -았/었기 때문에(늦었기 때문에「遅れたので」)。N + 때문에 が否定的な結果(失敗・非難・機会逸失)と組むと「〜のせいで」というニュアンスが出る(너 때문에 늦었어「君のせいで遅れた」)。「〜のおかげで」と肯定方向に和らげたいときは 덕분에 を使う(선생님 덕분에「先生のおかげで」)。',
    ),
    deckId: 'topik-2',
  },
  ...
  // G046 · Or (between verbs/adjectives)
  {
    ...
    usageNotes: L(
      'Marks "or" between verbs or adjectives — alternative actions / qualities. Form: attach -거나 directly to the verb / adjective stem regardless of vowel or consonant ending (보다 → 보거나, 먹다 → 먹거나, 좋다 → 좋거나). Two clauses around it act as a choice: A 또는 B / "A or B". Past goes inside in the first clause too if both clauses are past: 영화를 봤거나 책을 읽었어요 "I watched a movie or read a book".\n\nThe noun partner is (이)나, learned in TOPIK 1 — they don\'t mix. For nouns: 커피나 차 ("coffee or tea"); for verbs: 커피를 마시거나 차를 마시거나 해요 ("I drink coffee or tea"). A close cousin to watch: -든지 (어디든지, 누구든지 "anywhere / anyone") expresses "no matter which" rather than a plain "or" choice. For "either...or" emphasis, you can layer: -거나 -거나 ... 해요 ("either ... or ..."). At the end of a list of options, drop a 해요 to summarize: 산책하거나 카페에 가거나 해요 "I take a walk or go to a café (one of those)".',
      'Marca "o" entre verbos o adjetivos — acciones / cualidades alternativas. Forma: pegá -거나 directo a la raíz del verbo / adjetivo, sin importar vocal o consonante (보다 → 보거나, 먹다 → 먹거나, 좋다 → 좋거나). Las dos cláusulas alrededor funcionan como elección: A 또는 B / "A o B". El pasado va adentro de la primera cláusula también si ambas son pasadas: 영화를 봤거나 책을 읽었어요 "vi una peli o leí un libro".\n\nLa pareja para sustantivos es (이)나, vista en TOPIK 1 — no se mezclan. Con sustantivo: 커피나 차 ("café o té"); con verbos: 커피를 마시거나 차를 마시거나 해요 ("tomo café o té"). Primo cercano a tener en cuenta: -든지 (어디든지, 누구든지 "donde sea / quien sea") expresa "no importa cuál" más que una mera elección "o". Para enfatizar "o ... o ..." podés acumular: -거나 -거나 ... 해요. Al cerrar una lista de opciones, agregá 해요 para resumir: 산책하거나 카페에 가거나 해요 "salgo a caminar o voy a un café (una de esas dos)".',
      'Marque « ou » entre verbes ou adjectifs — actions / qualités alternatives. Forme : on colle -거나 à la racine du verbe / de l\'adjectif, qu\'elle finisse en voyelle ou en consonne (보다 → 보거나, 먹다 → 먹거나, 좋다 → 좋거나). Les deux propositions autour fonctionnent comme un choix : A 또는 B / « A ou B ». Le passé se loge aussi dans la 1ʳᵉ proposition si les deux le sont : 영화를 봤거나 책을 읽었어요 « j\'ai vu un film ou j\'ai lu un livre ».\n\nL\'équivalent pour les noms est (이)나, vu au TOPIK 1 — pas de mélange. Avec un nom : 커피나 차 (« café ou thé ») ; avec des verbes : 커피를 마시거나 차를 마시거나 해요 (« je bois du café ou du thé »). Cousin proche à connaître : -든지 (어디든지, 누구든지 « où que ce soit / qui que ce soit ») exprime « peu importe lequel », pas un simple choix « ou ». Pour insister sur « soit … soit … », on peut empiler : -거나 -거나 ... 해요. À la fin d\'une liste d\'options, un 해요 vient résumer : 산책하거나 카페에 가거나 해요 « je vais me promener ou je vais au café (l\'un ou l\'autre) ».',
      'Marca "ou" entre verbos ou adjetivos — ações / qualidades alternativas. Forma: anexe -거나 direto ao radical do verbo / adjetivo, independente de vogal ou consoante (보다 → 보거나, 먹다 → 먹거나, 좋다 → 좋거나). As duas orações em volta atuam como escolha: A 또는 B / "A ou B". O passado vai dentro da 1ª oração também, se ambas forem passadas: 영화를 봤거나 책을 읽었어요 "vi um filme ou li um livro".\n\nO parceiro para substantivos é (이)나, visto no TOPIK 1 — não se misturam. Com substantivo: 커피나 차 ("café ou chá"); com verbos: 커피를 마시거나 차를 마시거나 해요 ("tomo café ou chá"). Primo próximo para ficar atento: -든지 (어디든지, 누구든지 "onde quer que / quem quer que") expressa "não importa qual" e não uma simples escolha "ou". Para enfatizar "ou … ou …" dá pra empilhar: -거나 -거나 ... 해요. No fim de uma lista de opções, jogue um 해요 para resumir: 산책하거나 카페에 가거나 해요 "saio para caminhar ou vou ao café (uma dessas)".',
      'แสดง "หรือ" ระหว่างกริยา/คำคุณศัพท์ — การกระทำ/คุณสมบัติทางเลือก. รูป: เกาะ -거나 ที่รากกริยา/คำคุณศัพท์ ไม่ว่าจะลงสระหรือพยัญชนะ (보다 → 보거나, 먹다 → 먹거나, 좋다 → 좋거나). ทั้งสองประโยครอบข้างทำหน้าที่เป็นทางเลือก: A 또는 B / "A หรือ B". อดีตอยู่ในประโยคแรกด้วยถ้าทั้งคู่เป็นอดีต: 영화를 봤거나 책을 읽었어요 "ฉันดูหนังหรืออ่านหนังสือ"\n\nคู่ของคำนามคือ (이)나 ที่เรียนใน TOPIK 1 — ใช้ปนกันไม่ได้. กับคำนาม: 커피나 차 ("กาแฟหรือชา"); กับกริยา: 커피를 마시거나 차를 마시거나 해요 ("ดื่มกาแฟหรือชา"). ลูกพี่ลูกน้องที่ต้องสังเกต: -든지 (어디든지, 누구든지 "ที่ไหนก็ตาม / ใครก็ตาม") สื่อความหมาย "อันไหนก็ได้" มากกว่าการเลือก. ถ้าจะเน้น "ไม่...ก็..." วางซ้อนได้: -거나 -거나 ... 해요. ตอนปิดท้ายรายการตัวเลือก ใส่ 해요 สรุปเลย: 산책하거나 카페에 가거나 해요 "ฉันไปเดินเล่นหรือไม่ก็เข้าคาเฟ่"',
      'Menandai "atau" antar verba / adjektiva — aksi atau sifat alternatif. Bentuk: tempelkan -거나 langsung ke akar verba / adjektiva, tak peduli berakhiran vokal atau konsonan (보다 → 보거나, 먹다 → 먹거나, 좋다 → 좋거나). Dua klausa di sekitarnya menjadi pilihan: A 또는 B / "A atau B". Lampau juga masuk ke klausa pertama bila keduanya lampau: 영화를 봤거나 책을 읽었어요 "saya nonton film atau baca buku".\n\nPasangan untuk kata benda adalah (이)나, dipelajari di TOPIK 1 — keduanya tidak boleh tercampur. Dengan kata benda: 커피나 차 ("kopi atau teh"); dengan verba: 커피를 마시거나 차를 마시거나 해요 ("saya minum kopi atau teh"). Sepupu dekat untuk diperhatikan: -든지 (어디든지, 누구든지 "di mana saja / siapa saja") menyatakan "yang mana pun" alih-alih pilihan biasa. Untuk menekankan "entah … entah …" bisa ditumpuk: -거나 -거나 ... 해요. Di akhir daftar opsi, tambahkan 해요 untuk merangkum: 산책하거나 카페에 가거나 해요 "saya jalan-jalan atau pergi ke kafe (salah satu dari itu)".',
      'Đánh dấu "hoặc" giữa động từ / tính từ — hành động / tính chất thay thế. Hình thức: gắn -거나 trực tiếp vào gốc động từ / tính từ, dù kết bằng nguyên âm hay phụ âm (보다 → 보거나, 먹다 → 먹거나, 좋다 → 좋거나). Hai vế xung quanh đóng vai trò lựa chọn: A 또는 B / "A hoặc B". Quá khứ cũng đặt trong vế đầu nếu cả hai ở quá khứ: 영화를 봤거나 책을 읽었어요 "tôi đã xem phim hoặc đọc sách".\n\nCặp đôi cho danh từ là (이)나 đã học ở TOPIK 1 — không trộn lẫn. Với danh từ: 커피나 차 ("cà phê hoặc trà"); với động từ: 커피를 마시거나 차를 마시거나 해요 ("tôi uống cà phê hoặc trà"). Họ hàng cần để ý: -든지 (어디든지, 누구든지 "ở đâu cũng / ai cũng") thể hiện "bất kể cái nào" hơn là chỉ chọn. Để nhấn "hoặc ... hoặc ..." có thể chồng: -거나 -거나 ... 해요. Cuối danh sách lựa chọn, thêm 해요 để tóm: 산책하거나 카페에 가거나 해요 "tôi đi dạo hoặc vào quán cà phê (một trong hai)".',
      '動詞・形容詞をつないで「〜たり／または」を表す — 代替の動作・性質を列挙する。形: 動詞・形容詞の語幹に -거나 を直接付ける(母音・子音問わず)。(보다 → 보거나、먹다 → 먹거나、좋다 → 좋거나)。前後の二つの節は選択肢として機能する: A 또는 B「AまたはB」。両節とも過去なら前節にも過去を入れる: 영화를 봤거나 책을 읽었어요「映画を見たか本を読んだ」。\n\n名詞用のペアは TOPIK 1 で学んだ (이)나 — 混ぜない。名詞: 커피나 차「コーヒーか紅茶」、動詞: 커피를 마시거나 차를 마시거나 해요「コーヒーを飲んだり紅茶を飲んだりする」。よく似た親戚として注意したい -든지(어디든지、누구든지「どこでも／誰でも」)は「どれでも」のニュアンスで、単純な選択の「または」とは少し違う。「〜したり〜したり」を強調するときは繰り返せる: -거나 -거나 ... 해요。選択肢の列の締めくくりに 해요 を置いて要約: 산책하거나 카페에 가거나 해요「散歩したりカフェに行ったりします」。',
    ),
    deckId: 'topik-2',
  },
  ...
  // G052 · Like / similar to
  {
    ...
    usageNotes: L(
      'Marks comparison or resemblance — "like / similar to". Both particles attach DIRECTLY to a noun: 친구처럼 ("like a friend"), 친구같이 ("like a friend"), 아이처럼 ("like a child"). They sit between the noun and the verb / adjective they modify: 어른처럼 말해요 "speak like an adult". The two are largely interchangeable, though 처럼 is more written / neutral and 같이 a touch more colloquial.\n\nWatch for two confusables. (1) 같이 has a second life as the adverb "together" (TOPIK 1: 친구하고 같이 "with a friend"), which is unrelated to this comparison use — context tells them apart. (2) 같다 is the verb "to be similar / the same" — N + 같다 ("looks like an N", 한국 사람 같아요 "looks Korean"). For "as if doing" with a verb, use -는 것처럼 (자는 것처럼 "as if sleeping"). To express "as much as" rather than "like", switch to -만큼 (어른만큼 키가 커요 "as tall as an adult"). Idiomatic: 매일처럼 ("as if every day"), 봄처럼 따뜻해요 ("warm like spring").',
      'Marca comparación o semejanza — "como / igual que". Las dos partículas se pegan DIRECTO al sustantivo: 친구처럼 ("como un amigo"), 친구같이 ("como un amigo"), 아이처럼 ("como un niño"). Van entre el sustantivo y el verbo / adjetivo que modifican: 어른처럼 말해요 "hablá como un adulto". Las dos son en gran parte intercambiables, aunque 처럼 es más escrito / neutro y 같이 algo más coloquial.\n\nOjo con dos confusiones. (1) 같이 también vive como el adverbio "juntos" (TOPIK 1: 친구하고 같이 "con un amigo"), que no tiene nada que ver con esta comparación — el contexto los separa. (2) 같다 es el verbo "ser parecido / igual" — N + 같다 ("parece un N", 한국 사람 같아요 "parece coreano"). Para "como si hiciera" con verbo, usá -는 것처럼 (자는 것처럼 "como si durmiera"). Para "tanto como" en vez de "como", cambialo a -만큼 (어른만큼 키가 커요 "es tan alto como un adulto"). Idiomático: 매일처럼 ("como si fuera todos los días"), 봄처럼 따뜻해요 ("cálido como la primavera").',
      'Marque la comparaison ou la ressemblance — « comme / pareil à ». Les deux particules se collent DIRECTEMENT au nom : 친구처럼 (« comme un ami »), 친구같이 (« comme un ami »), 아이처럼 (« comme un enfant »). Elles se placent entre le nom et le verbe / adjectif qu\'elles modifient : 어른처럼 말해요 « parle comme un adulte ». Les deux sont largement interchangeables ; 처럼 sonne plus écrit / neutre, 같이 un peu plus familier.\n\nDeux pièges à connaître. (1) 같이 a une seconde vie comme adverbe « ensemble » (TOPIK 1 : 친구하고 같이 « avec un ami »), sans rapport avec la comparaison — le contexte sépare les deux emplois. (2) 같다 est le verbe « être semblable / pareil » — N + 같다 (« on dirait un N », 한국 사람 같아요 « il a l\'air coréen »). Pour « comme si on faisait » avec un verbe, employer -는 것처럼 (자는 것처럼 « comme s\'il dormait »). Pour « autant que » plutôt que « comme », passer à -만큼 (어른만큼 키가 커요 « aussi grand qu\'un adulte »). Tournures idiomatiques : 매일처럼 (« comme tous les jours »), 봄처럼 따뜻해요 (« chaud comme le printemps »).',
      'Marca comparação ou semelhança — "como / igual a". As duas partículas se anexam DIRETAMENTE ao substantivo: 친구처럼 ("como um amigo"), 친구같이 ("como um amigo"), 아이처럼 ("como uma criança"). Ficam entre o substantivo e o verbo / adjetivo que modificam: 어른처럼 말해요 "fale como um adulto". As duas são bastante intercambiáveis, mas 처럼 é mais escrita / neutra e 같이 um tanto mais coloquial.\n\nDois pontos para não confundir. (1) 같이 também atua como advérbio "juntos" (TOPIK 1: 친구하고 같이 "com um amigo"), sem relação com esta comparação — o contexto separa. (2) 같다 é o verbo "ser parecido / igual" — N + 같다 ("parece um N", 한국 사람 같아요 "parece coreano"). Para "como se estivesse" com verbo, use -는 것처럼 (자는 것처럼 "como se estivesse dormindo"). Para "tão … quanto" em vez de "como", troque para -만큼 (어른만큼 키가 커요 "tão alto quanto um adulto"). Idiomático: 매일처럼 ("como se fosse todo dia"), 봄처럼 따뜻해요 ("quente como a primavera").',
      'แสดงการเปรียบเทียบหรือความคล้าย — "เหมือน / เช่น". อนุภาคทั้งสองตัวเกาะ "ตรง" คำนาม: 친구처럼 ("เหมือนเพื่อน"), 친구같이 ("เหมือนเพื่อน"), 아이처럼 ("เหมือนเด็ก"). อยู่ระหว่างคำนามกับกริยา/คำคุณศัพท์ที่ขยาย: 어른처럼 말해요 "พูดเหมือนผู้ใหญ่". ใช้แทนกันได้เกือบทั้งหมด แต่ 처럼 ออกแนวเขียน/เป็นกลางกว่า ส่วน 같이 พูดเป็นกันเองกว่านิดหน่อย\n\nระวังสองจุดสับสน. (1) 같이 ยังมีอีกชีวิตเป็นคำวิเศษณ์ "ด้วยกัน" (TOPIK 1: 친구하고 같이 "กับเพื่อน") ซึ่งไม่เกี่ยวกับการเปรียบเทียบ — บริบทแยกได้. (2) 같다 เป็นกริยาว่า "เหมือน / เป็นเช่น" — N + 같다 ("ดูเหมือน N", 한국 사람 같아요 "ดูเป็นคนเกาหลี"). หากจะแปลว่า "ราวกับว่าทำ" คู่กับกริยา ใช้ -는 것처럼 (자는 것처럼 "ราวกับนอนหลับ"). หากจะแปล "เท่า ๆ กับ" แทน "เหมือน" ให้เปลี่ยนเป็น -만큼 (어른만큼 키가 커요 "สูงเท่าผู้ใหญ่"). สำนวน: 매일처럼 ("ราวกับทุกวัน"), 봄처럼 따뜻해요 ("อบอุ่นเหมือนฤดูใบไม้ผลิ")',
      'Menandai perbandingan atau kemiripan — "seperti / sama seperti". Kedua partikel menempel LANGSUNG pada kata benda: 친구처럼 ("seperti teman"), 친구같이 ("seperti teman"), 아이처럼 ("seperti anak kecil"). Diletakkan antara kata benda dan verba / adjektiva yang dimodifikasi: 어른처럼 말해요 "berbicara seperti orang dewasa". Keduanya sebagian besar dapat dipertukarkan, namun 처럼 lebih ke ranah tulis / netral dan 같이 sedikit lebih percakapan.\n\nDua titik rancu yang perlu diperhatikan. (1) 같이 juga punya kehidupan kedua sebagai adverbia "bersama" (TOPIK 1: 친구하고 같이 "bersama teman"), yang tidak ada hubungannya dengan pembandingan ini — konteks memisahkan keduanya. (2) 같다 adalah verba "mirip / sama" — N + 같다 ("kelihatan seperti N", 한국 사람 같아요 "kelihatan orang Korea"). Untuk "seolah-olah melakukan" dengan verba, pakai -는 것처럼 (자는 것처럼 "seolah-olah tidur"). Untuk "sama seperti / sebanyak" alih-alih "seperti", ganti ke -만큼 (어른만큼 키가 커요 "setinggi orang dewasa"). Idiomatik: 매일처럼 ("seolah-olah setiap hari"), 봄처럼 따뜻해요 ("hangat seperti musim semi").',
      'Đánh dấu so sánh hoặc tương đồng — "giống / như". Cả hai tiểu từ gắn TRỰC TIẾP vào danh từ: 친구처럼 ("như một người bạn"), 친구같이 ("như một người bạn"), 아이처럼 ("như trẻ con"). Đứng giữa danh từ và động từ / tính từ mà nó tu sức: 어른처럼 말해요 "nói như người lớn". Hai tiểu từ phần lớn thay thế được nhau, nhưng 처럼 thiên về văn viết / trung tính còn 같이 hơi thân mật hơn chút.\n\nHai điểm dễ nhầm cần lưu ý. (1) 같이 có một mặt khác là trạng từ "cùng nhau" (TOPIK 1: 친구하고 같이 "với bạn"), không liên quan tới so sánh — ngữ cảnh phân biệt. (2) 같다 là động từ "giống / như nhau" — N + 같다 ("trông như một N", 한국 사람 같아요 "trông như người Hàn"). Để diễn tả "như thể đang làm" với động từ, dùng -는 것처럼 (자는 것처럼 "như thể đang ngủ"). Để diễn tả "bằng" thay vì "giống", chuyển sang -만큼 (어른만큼 키가 커요 "cao bằng người lớn"). Thành ngữ: 매일처럼 ("như thể mỗi ngày"), 봄처럼 따뜻해요 ("ấm như mùa xuân").',
      '比較や類似を表す「〜のように／〜みたいに」。両方の助詞は名詞に「直接」付ける: 친구처럼(「友達のように」)、친구같이(「友達のように」)、아이처럼(「子どものように」)。修飾する動詞・形容詞の前に置く: 어른처럼 말해요「大人のように話してください」。両者はほぼ自由に置換可能だが、처럼 のほうが文章的・中立、같이 のほうがやや口語寄り。\n\n注意したい混同が二つ。(1) 같이 は副詞「いっしょに」の用法も持つ(TOPIK 1: 친구하고 같이「友達と一緒に」)。これは比較とは無関係 — 文脈で区別する。(2) 같다 は「似ている／同じだ」を意味する動詞 — N + 같다(「Nのようだ」、한국 사람 같아요「韓国の方のようです」)。動詞に付けて「〜するように／〜するみたいに」と言いたい場合は -는 것처럼 を使う(자는 것처럼「寝ているように」)。「〜のように」ではなく「〜ほど／〜くらい」と言いたいなら -만큼 に切り替える(어른만큼 키가 커요「大人くらい背が高い」)。慣用: 매일처럼(「毎日のように」)、봄처럼 따뜻해요(「春のように暖かい」)。',
    ),
    deckId: 'topik-2',
  },
  ...
  // G053 · More than (comparison)
  {
    ...
    usageNotes: L(
      'Marks the standard of comparison — "than X". The particle 보다 attaches DIRECTLY to the noun that\'s the benchmark: 일본어보다 ("than Japanese"), 어제보다 ("than yesterday"), 너보다 ("than you"). The thing being compared is the subject of the sentence, marked normally with 은/는 or 이/가. Korean has no separate "more" word like English — the comparison is in 보다 itself.\n\n더 ("more") is the natural intensifier and shows up everywhere — A는 B보다 더 좋아요 "A is even better than B". To say "much more", layer 훨씬 (훨씬 더 좋아요 "much better"). To flip and say "less than", use 덜: B보다 덜 좋아요 "less good than B". For "the most" (superlative), reach instead for 제일 / 가장: 제일 좋아요 "the best". Word order is flexible — you can also front the benchmark: 일본어보다 한국어가 어려워요. Don\'t confuse with the verb 보다 ("see") — same spelling, totally different grammar.',
      'Marca el patrón de comparación — "que X". La partícula 보다 se pega DIRECTO al sustantivo que sirve de referencia: 일본어보다 ("que el japonés"), 어제보다 ("que ayer"), 너보다 ("que vos"). Lo comparado es el sujeto de la oración, marcado normalmente con 은/는 o 이/가. El coreano no tiene una palabra separada para "más" como el inglés — la comparación vive en el propio 보다.\n\n더 ("más") es el intensificador natural y aparece por todos lados — A는 B보다 더 좋아요 "A es aún mejor que B". Para "mucho más" sumá 훨씬 (훨씬 더 좋아요 "mucho mejor"). Para invertir y decir "menos que" usá 덜: B보다 덜 좋아요 "menos bueno que B". Para "el más" (superlativo) usá 제일 / 가장: 제일 좋아요 "el mejor". El orden es flexible — también podés adelantar el patrón: 일본어보다 한국어가 어려워요. No lo confundas con el verbo 보다 ("ver") — misma escritura, gramática totalmente distinta.',
      'Marque l\'étalon de comparaison — « que X ». La particule 보다 se colle DIRECTEMENT au nom qui sert de référence : 일본어보다 (« que le japonais »), 어제보다 (« que hier »), 너보다 (« que toi »). L\'élément comparé est le sujet de la phrase, marqué normalement par 은/는 ou 이/가. Le coréen n\'a pas de mot séparé pour « plus » à la manière du français — la comparaison vit dans 보다 lui-même.\n\n더 (« plus ») est l\'intensificateur naturel et apparaît partout — A는 B보다 더 좋아요 « A est encore meilleur que B ». Pour « beaucoup plus », empile 훨씬 (훨씬 더 좋아요 « bien meilleur »). Pour inverser et dire « moins que », utilise 덜 : B보다 덜 좋아요 « moins bon que B ». Pour le superlatif « le plus », passe à 제일 / 가장 : 제일 좋아요 « le meilleur ». L\'ordre est souple — on peut aussi antéposer le standard : 일본어보다 한국어가 어려워요. À ne pas confondre avec le verbe 보다 (« voir ») — même orthographe, grammaire totalement différente.',
      'Marca o padrão de comparação — "que X". A partícula 보다 se anexa DIRETAMENTE ao substantivo que serve de referência: 일본어보다 ("que o japonês"), 어제보다 ("que ontem"), 너보다 ("que você"). O elemento comparado é o sujeito da frase, marcado normalmente com 은/는 ou 이/가. Coreano não tem palavra separada para "mais" como em português — a comparação mora no próprio 보다.\n\n더 ("mais") é o intensificador natural e aparece em todo lugar — A는 B보다 더 좋아요 "A é ainda melhor que B". Para "muito mais", junte 훨씬 (훨씬 더 좋아요 "muito melhor"). Para inverter e dizer "menos que" use 덜: B보다 덜 좋아요 "menos bom que B". Para "o mais" (superlativo), use 제일 / 가장: 제일 좋아요 "o melhor". A ordem é flexível — você também pode antepor o padrão: 일본어보다 한국어가 어려워요. Não confunda com o verbo 보다 ("ver") — mesma grafia, gramática totalmente diferente.',
      'แสดงเกณฑ์เปรียบเทียบ — "กว่า X". อนุภาค 보다 เกาะ "ตรง" คำนามที่เป็นเกณฑ์: 일본어보다 ("กว่าภาษาญี่ปุ่น"), 어제보다 ("กว่าเมื่อวาน"), 너보다 ("กว่าเธอ"). สิ่งที่ถูกเปรียบเทียบเป็นประธานของประโยค ใช้ 은/는 หรือ 이/가 ตามปกติ. ภาษาเกาหลีไม่มีคำว่า "มากกว่า" แยกแบบภาษาอังกฤษ — ความหมายอยู่ที่ 보다 เอง\n\n더 ("ยิ่ง / มากกว่า") เป็นตัวเสริมที่เป็นธรรมชาติและพบทุกที่ — A는 B보다 더 좋아요 "A ดีกว่า B อีก". จะบอก "มากกว่ามาก" ใส่ 훨씬 (훨씬 더 좋아요 "ดีกว่ามาก"). ถ้าจะกลับเป็น "น้อยกว่า" ใช้ 덜: B보다 덜 좋아요 "ดีน้อยกว่า B". ขั้นเลิศ "ที่สุด" ใช้ 제일 / 가장: 제일 좋아요 "ดีที่สุด". ลำดับยืดหยุ่น — เลื่อนเกณฑ์ขึ้นต้นได้: 일본어보다 한국어가 어려워요. อย่าสับสนกับกริยา 보다 ("ดู") — สะกดเหมือนกัน ไวยากรณ์คนละเรื่อง',
      'Menandai standar perbandingan — "daripada X". Partikel 보다 menempel LANGSUNG ke kata benda yang menjadi acuan: 일본어보다 ("daripada bahasa Jepang"), 어제보다 ("daripada kemarin"), 너보다 ("daripada kamu"). Yang dibandingkan adalah subjek kalimat, ditandai 은/는 atau 이/가 seperti biasa. Bahasa Korea tidak punya kata terpisah untuk "lebih" seperti bahasa Inggris — perbandingan ada di 보다 itu sendiri.\n\n더 ("lebih") adalah penekan alami dan muncul di mana-mana — A는 B보다 더 좋아요 "A bahkan lebih baik daripada B". Untuk "jauh lebih" tumpuk 훨씬 (훨씬 더 좋아요 "jauh lebih baik"). Untuk membalik menjadi "kurang dari" pakai 덜: B보다 덜 좋아요 "kurang baik dibanding B". Untuk superlatif "paling", gunakan 제일 / 가장: 제일 좋아요 "yang terbaik". Urutan kata fleksibel — bisa juga menaruh standarnya di depan: 일본어보다 한국어가 어려워요. Jangan tertukar dengan verba 보다 ("melihat") — ejaan sama, tata bahasa beda total.',
      'Đánh dấu mốc so sánh — "hơn X". Tiểu từ 보다 gắn TRỰC TIẾP vào danh từ làm mốc: 일본어보다 ("hơn tiếng Nhật"), 어제보다 ("hơn hôm qua"), 너보다 ("hơn bạn"). Đối tượng được so sánh là chủ ngữ của câu, đánh dấu bằng 은/는 hoặc 이/가 như thường lệ. Tiếng Hàn không có từ riêng cho "hơn / more" như tiếng Anh — sự so sánh nằm trong chính 보다.\n\n더 ("hơn / nhiều hơn") là từ tăng cường tự nhiên và xuất hiện khắp nơi — A는 B보다 더 좋아요 "A còn tốt hơn B". Để nói "tốt hơn nhiều" thêm 훨씬 (훨씬 더 좋아요 "tốt hơn nhiều"). Để đảo thành "kém hơn" dùng 덜: B보다 덜 좋아요 "kém tốt hơn B". So sánh nhất "nhất" dùng 제일 / 가장: 제일 좋아요 "tốt nhất". Thứ tự linh hoạt — cũng có thể đưa mốc lên đầu: 일본어보다 한국어가 어려워요. Đừng nhầm với động từ 보다 ("nhìn") — viết giống nhau, ngữ pháp khác hoàn toàn.',
      '比較の基準を表す「〜より」。助詞 보다 は基準となる名詞に「直接」付ける: 일본어보다(「日本語より」)、어제보다(「昨日より」)、너보다(「君より」)。比較される側は文の主語で、通常通り 은/는 や 이/가 で標示する。韓国語には英語の「more」のように独立した語がない — 比較の意味は 보다 自体に含まれている。\n\n더(「もっと／さらに」)は自然な強調で、ほぼどこにでも現れる — A는 B보다 더 좋아요「AはBよりさらにいい」。「ずっと」を加えるなら 훨씬(훨씬 더 좋아요「ずっといい」)を重ねる。逆に「より少なく」と言いたいときは 덜 を使う: B보다 덜 좋아요「Bほどよくない」。最上級「いちばん／最も」には 제일 / 가장 を使う(제일 좋아요「いちばんいい」)。語順は柔軟 — 基準を前に出すこともできる(일본어보다 한국어가 어려워요)。동사 보다(「見る」)とはつづりが同じだが文法は別物 — 混同しない。',
    ),
    deckId: 'topik-2',
  },
  ...
  // G049 · Indirect question
  {
    ...
    usageNotes: L(
      'Embeds a question inside a larger sentence — the equivalent of "whether / what / where / when / why / how + clause". Form follows the modifier rules: action verb present → -는지 (가는지 알아요? "do you know if they\'re going?"); adjective / copula present → -(으)ㄴ지 (얼마나 큰지 "how big it is", 학생인지 "whether they\'re a student"); past (any) → -았/었는지 from a verb (왔는지 "whether they came"); future / supposition → -(으)ㄹ지 (올지 "whether they\'ll come"). The whole -지 clause acts as a noun — it commonly pairs with knowing / wondering verbs: 알다, 모르다, 궁금하다, 묻다, 생각하다, 결정하다.\n\nThe interrogatives sit INSIDE the clause as you\'d expect for Korean — no fronting. 누가 했는지 몰라요 "I don\'t know who did it" (NOT 몰라요 누가 했는지). For yes/no embedded questions, you can stack it: -(으)ㄴ지 아닌지 ("whether or not"): 갈지 안 갈지 모르겠어요 "I\'m not sure whether I\'ll go or not". To talk about HOW MUCH of something, -(으)ㄴ지 with 얼마나 is the canonical way: 얼마나 비싼지 몰라요 "you have no idea how expensive it is" — a common emphatic exclamation pattern in everyday speech.',
      'Inserta una pregunta dentro de una oración mayor — equivalente a "si / qué / dónde / cuándo / por qué / cómo + cláusula". La forma sigue las reglas de los modificadores: verbo de acción presente → -는지 (가는지 알아요? "¿sabés si va?"); adjetivo / cópula presente → -(으)ㄴ지 (얼마나 큰지 "qué tan grande es", 학생인지 "si es estudiante"); pasado (cualquiera) → -았/었는지 con verbo (왔는지 "si vino"); futuro / suposición → -(으)ㄹ지 (올지 "si va a venir"). Toda la cláusula -지 actúa como un sustantivo — se empareja muy comúnmente con verbos de conocimiento / duda: 알다, 모르다, 궁금하다, 묻다, 생각하다, 결정하다.\n\nLos interrogativos quedan ADENTRO de la cláusula como espera el coreano — no se adelantan. 누가 했는지 몰라요 "no sé quién lo hizo" (NO 몰라요 누가 했는지). Para preguntas indirectas de sí/no podés acumular: -(으)ㄴ지 아닌지 ("si o no"): 갈지 안 갈지 모르겠어요 "no sé si voy a ir o no". Para hablar de "cuánto" de algo, -(으)ㄴ지 con 얼마나 es la fórmula canónica: 얼마나 비싼지 몰라요 "no te imaginás lo caro que es" — un patrón exclamativo enfático muy usado en el habla diaria.',
      'Insère une question à l\'intérieur d\'une phrase plus large — équivalent de « si / quoi / où / quand / pourquoi / comment + proposition ». La forme suit les règles des modificateurs : verbe d\'action au présent → -는지 (가는지 알아요? « sais-tu s\'il y va ? ») ; adjectif / copule au présent → -(으)ㄴ지 (얼마나 큰지 « à quel point c\'est grand », 학생인지 « si c\'est un étudiant ») ; passé (toutes catégories) → -았/었는지 sur un verbe (왔는지 « s\'il est venu ») ; futur / supposition → -(으)ㄹ지 (올지 « s\'il viendra »). La proposition en -지 fonctionne comme un nom — elle se combine surtout avec des verbes de connaissance / interrogation : 알다, 모르다, 궁금하다, 묻다, 생각하다, 결정하다.\n\nLes interrogatifs restent À L\'INTÉRIEUR de la proposition, comme le coréen le veut — pas d\'antéposition. 누가 했는지 몰라요 « je ne sais pas qui l\'a fait » (et non 몰라요 누가 했는지). Pour des questions indirectes oui/non on peut empiler : -(으)ㄴ지 아닌지 (« si … ou non ») : 갈지 안 갈지 모르겠어요 « je ne sais pas si j\'y vais ou non ». Pour parler du DEGRÉ, -(으)ㄴ지 avec 얼마나 est la formule canonique : 얼마나 비싼지 몰라요 « tu n\'imagines pas à quel point c\'est cher » — c\'est aussi une exclamation emphatique très courante à l\'oral.',
      'Insere uma pergunta dentro de uma frase maior — equivalente a "se / o que / onde / quando / por que / como + oração". A forma segue as regras dos modificadores: verbo de ação no presente → -는지 (가는지 알아요? "você sabe se ele(a) vai?"); adjetivo / cópula no presente → -(으)ㄴ지 (얼마나 큰지 "quão grande é", 학생인지 "se é estudante"); passado (qualquer) → -았/었는지 com verbo (왔는지 "se veio"); futuro / suposição → -(으)ㄹ지 (올지 "se virá"). Toda a oração com -지 funciona como um substantivo — combina muito com verbos de conhecimento / dúvida: 알다, 모르다, 궁금하다, 묻다, 생각하다, 결정하다.\n\nOs interrogativos ficam DENTRO da oração como o coreano espera — sem antepor. 누가 했는지 몰라요 "não sei quem fez" (NÃO 몰라요 누가 했는지). Para perguntas indiretas sim/não pode acumular: -(으)ㄴ지 아닌지 ("se ou não"): 갈지 안 갈지 모르겠어요 "não sei se vou ou não". Para falar de "o quanto" de algo, -(으)ㄴ지 com 얼마나 é a fórmula canônica: 얼마나 비싼지 몰라요 "você nem imagina como é caro" — também é um padrão exclamativo enfático muito usado na fala.',
      'ฝังคำถามไว้ในประโยคใหญ่กว่า — เทียบเท่า "ว่า / อะไร / ที่ไหน / เมื่อไหร่ / ทำไม / อย่างไร + ประโยค". รูปตามกฎตัวขยาย: กริยาแสดงการกระทำปัจจุบัน → -는지 (가는지 알아요? "รู้ไหมว่าเขาไป?"); คำคุณศัพท์ / กริยานุเคราะห์ปัจจุบัน → -(으)ㄴ지 (얼마나 큰지 "ใหญ่ขนาดไหน", 학생인지 "ว่าเป็นนักเรียนหรือเปล่า"); อดีต (ทุกรูป) → -았/었는지 จากกริยา (왔는지 "ว่ามาหรือเปล่า"); อนาคต / คาดเดา → -(으)ㄹ지 (올지 "ว่าจะมาหรือไม่"). ประโยคที่ลงท้ายด้วย -지 ทำหน้าที่เหมือนคำนาม — มักคู่กับกริยาแสดงการรู้/สงสัย: 알다, 모르다, 궁금하다, 묻다, 생각하다, 결정하다\n\nคำถาม "อยู่ใน" ประโยคตามที่ภาษาเกาหลีคาด — ไม่ย้ายขึ้นต้น. 누가 했는지 몰라요 "ฉันไม่รู้ว่าใครทำ" (ห้าม 몰라요 누가 했는지). คำถามอ้อมแบบใช่/ไม่ใช่ ซ้อนได้: -(으)ㄴ지 아닌지 ("ว่า ... หรือไม่"): 갈지 안 갈지 모르겠어요 "ไม่รู้ว่าจะไปหรือไม่ไป". หากจะพูดว่า "แค่ไหน / มากเพียงใด" -(으)ㄴ지 คู่กับ 얼마나 เป็นสูตรมาตรฐาน: 얼마나 비싼지 몰라요 "นึกไม่ออกเลยว่าแพงขนาดไหน" — เป็นสำนวนอุทานที่ใช้บ่อยในการพูดประจำวันด้วย',
      'Menempelkan pertanyaan ke dalam kalimat yang lebih besar — setara dengan "apakah / apa / di mana / kapan / mengapa / bagaimana + klausa". Bentuk mengikuti aturan pemodifikasi: verba aksi kini → -는지 (가는지 알아요? "kamu tahu apakah dia pergi?"); adjektiva / kopula kini → -(으)ㄴ지 (얼마나 큰지 "seberapa besar", 학생인지 "apakah dia pelajar"); lampau (apa pun) → -았/었는지 dari verba (왔는지 "apakah dia datang"); masa depan / dugaan → -(으)ㄹ지 (올지 "apakah akan datang"). Seluruh klausa -지 berfungsi sebagai kata benda — sangat sering dipasangkan dengan verba pengetahuan / pertanyaan: 알다, 모르다, 궁금하다, 묻다, 생각하다, 결정하다.\n\nKata tanya tetap DI DALAM klausa sesuai cara Korea — tidak ditarik ke depan. 누가 했는지 몰라요 "saya tidak tahu siapa yang melakukan" (BUKAN 몰라요 누가 했는지). Untuk pertanyaan ya/tidak tak langsung bisa ditumpuk: -(으)ㄴ지 아닌지 ("apakah ... atau tidak"): 갈지 안 갈지 모르겠어요 "saya tidak yakin akan pergi atau tidak". Untuk berbicara tentang "seberapa" sesuatu, -(으)ㄴ지 dengan 얼마나 adalah formula bakunya: 얼마나 비싼지 몰라요 "kamu tidak tahu betapa mahalnya" — pola seruan tegas yang umum dalam percakapan sehari-hari.',
      'Lồng câu hỏi vào trong câu lớn — tương đương "liệu / cái gì / ở đâu / khi nào / tại sao / thế nào + mệnh đề". Hình thức theo quy tắc định ngữ: động từ hành động hiện tại → -는지 (가는지 알아요? "bạn có biết người đó có đi không?"); tính từ / hệ từ hiện tại → -(으)ㄴ지 (얼마나 큰지 "lớn cỡ nào", 학생인지 "có phải học sinh hay không"); quá khứ (mọi loại) → -았/었는지 từ động từ (왔는지 "có đến hay không"); tương lai / suy đoán → -(으)ㄹ지 (올지 "có sẽ đến hay không"). Cả mệnh đề -지 hoạt động như một danh từ — rất hay đi cùng động từ chỉ sự biết / thắc mắc: 알다, 모르다, 궁금하다, 묻다, 생각하다, 결정하다.\n\nTừ để hỏi nằm BÊN TRONG mệnh đề như tiếng Hàn quen — không đảo lên đầu. 누가 했는지 몰라요 "tôi không biết ai đã làm" (KHÔNG phải 몰라요 누가 했는지). Cho câu hỏi gián tiếp dạng có/không có thể chồng: -(으)ㄴ지 아닌지 ("liệu ... hay không"): 갈지 안 갈지 모르겠어요 "tôi không chắc có đi hay không". Để nói về MỨC ĐỘ "đến mức nào", -(으)ㄴ지 với 얼마나 là công thức chuẩn: 얼마나 비싼지 몰라요 "bạn không thể tưởng tượng nó đắt đến mức nào" — đây cũng là mẫu cảm thán nhấn mạnh phổ biến trong khẩu ngữ.',
      'より大きな文の中に疑問を組み込む「〜のか／〜かどうか」。修飾語のルールに従う: 現在の動作動詞 → -는지(가는지 알아요?「行くのか知っていますか?」); 現在の形容詞・繋辞 → -(으)ㄴ지(얼마나 큰지「どれほど大きいか」、학생인지「学生かどうか」); 過去(動詞・形容詞共通) → -았/었는지 を動詞から(왔는지「来たかどうか」); 未来・推量 → -(으)ㄹ지(올지「来るかどうか」)。-지 を含む節は名詞のように働き、知る／気になる系の動詞と非常によく組む: 알다、모르다、궁금하다、묻다、생각하다、결정하다。\n\n疑問詞は韓国語らしく節の「内側」にとどまり、文頭に出さない: 누가 했는지 몰라요「誰がやったのか分かりません」(몰라요 누가 했는지 とは言わない)。Yes/No の間接疑問は重ねられる: -(으)ㄴ지 아닌지(「〜かどうか」): 갈지 안 갈지 모르겠어요「行くかどうか分からない」。「どれほど」と程度を述べたいときは -(으)ㄴ지 を 얼마나 と組むのが定番: 얼마나 비싼지 몰라요「どれほど高いか言葉にできないくらいです」 — 日常会話で強い感嘆としても多用される。',
    ),
    deckId: 'topik-2',
  },
  ...
  // G057 · Soft context ending
  {
    ...
    usageNotes: L(
      'A soft sentence-final ending that leaves the next move to the listener — "the thing is... / well, ..." Form follows the modifier rules of TOPIK 1\'s -ㄴ/는데 connector but at the END of a sentence: action verb present → -는데요 (가는데요 "well, I\'m going..."); adjective / copula present → -(으)ㄴ데요 (비싼데요 "it\'s pricey, though..."); past (any) → -았/었는데요 (왔는데요 "well, they came..."); future / supposition → -(으)ㄹ건데요 (informal). The trailing -요 keeps it polite.\n\nThree common moves it does. (1) Soft pushback / disagreement: 좀 비싼데요... ("it\'s a bit expensive, though...", inviting "could you discount it?"). (2) Friendly setup of context: 사실 제가 처음인데요... ("actually, it\'s my first time..."). (3) Reacting with mild surprise: 와, 정말 잘하시는데요! ("wow, you\'re really good at it!"). Conversational cousin: the dangling -데(요)... that often trails off and lets the listener fill in — Korean culturally prefers this kind of indirectness over flat statements. Don\'t confuse with the sentence-initial connector 그런데 ("by the way / however"), which lives at the start of a follow-up sentence.',
      'Una terminación final suave que deja el próximo movimiento al oyente — "es que... / bueno, ...". La forma sigue las reglas de modificador del conector -ㄴ/는데 de TOPIK 1 pero al FINAL de la oración: verbo de acción presente → -는데요 (가는데요 "es que voy..."); adjetivo / cópula presente → -(으)ㄴ데요 (비싼데요 "es caro, eh..."); pasado (cualquiera) → -았/었는데요 (왔는데요 "es que ya vinieron..."); futuro / suposición → -(으)ㄹ건데요 (informal). La cola -요 lo mantiene educado.\n\nTres movidas frecuentes. (1) Objeción suave / desacuerdo: 좀 비싼데요... ("es un poquito caro, eh...", invitando a "¿no podrías hacerme precio?"). (2) Apertura amigable de contexto: 사실 제가 처음인데요... ("la verdad, es mi primera vez..."). (3) Reacción con sorpresa leve: 와, 정말 잘하시는데요! ("¡wow, sos muy buena/o!"). Primo conversacional: el -데(요)... colgando al final que deja al oyente completar — el coreano prefiere culturalmente esta indirección antes que las afirmaciones planas. No lo confundas con el conector inicial 그런데 ("por cierto / sin embargo"), que vive al comienzo de la siguiente oración.',
      'Une terminaison de phrase douce qui laisse l\'initiative à l\'interlocuteur — « il faut savoir que… / eh bien… ». La forme suit les règles de modificateur du connecteur -ㄴ/는데 du TOPIK 1, mais en FIN de phrase : verbe d\'action au présent → -는데요 (가는데요 « eh bien, j\'y vais… ») ; adjectif / copule au présent → -(으)ㄴ데요 (비싼데요 « c\'est cher, mais… ») ; passé (toutes catégories) → -았/었는데요 (왔는데요 « eh bien, ils sont venus… ») ; futur / supposition → -(으)ㄹ건데요 (familier). La désinence -요 maintient la politesse.\n\nTrois usages courants. (1) Objection en douceur : 좀 비싼데요... (« c\'est un peu cher, en fait… », laissant entendre « pourriez-vous baisser ? »). (2) Mise en contexte amicale : 사실 제가 처음인데요... (« en fait, c\'est ma première fois… »). (3) Réaction d\'étonnement léger : 와, 정말 잘하시는데요! (« waouh, vous êtes vraiment doué·e ! »). Cousin oral : le -데(요)... laissé en suspens à la fin, qui laisse l\'interlocuteur compléter — le coréen privilégie culturellement ce type d\'indirection plutôt que les affirmations tranchées. À ne pas confondre avec le connecteur initial 그런데 (« au fait / cependant »), qui ouvre la phrase suivante.',
      'Uma terminação final suave que deixa o próximo passo nas mãos do ouvinte — "acontece que... / é que...". A forma segue as regras de modificador do conector -ㄴ/는데 do TOPIK 1, mas no FIM da frase: verbo de ação no presente → -는데요 (가는데요 "é que vou..."); adjetivo / cópula no presente → -(으)ㄴ데요 (비싼데요 "é caro, viu..."); passado (qualquer) → -았/었는데요 (왔는데요 "acontece que já vieram..."); futuro / suposição → -(으)ㄹ건데요 (informal). O rabicho -요 mantém polido.\n\nTrês movimentos comuns. (1) Objeção suave / discordância: 좀 비싼데요... ("está um pouco caro, viu...", convidando "dá um desconto?"). (2) Abertura amigável de contexto: 사실 제가 처음인데요... ("na verdade, é minha primeira vez..."). (3) Reação com surpresa leve: 와, 정말 잘하시는데요! ("nossa, você é muito bom/boa!"). Primo conversacional: o -데(요)... que fica solto no fim e deixa o ouvinte completar — o coreano culturalmente prefere essa indireção a afirmações cortantes. Não confunda com o conector inicial 그런데 ("aliás / no entanto"), que mora no começo da frase seguinte.',
      'รูปจบประโยคที่นุ่มและทิ้งให้ผู้ฟังตอบสนอง — "คือว่า ... / เอ่อ ...". รูปตามตัวขยายเหมือนตัวเชื่อม -ㄴ/는데 จาก TOPIK 1 แต่อยู่ "ท้ายประโยค": กริยาแสดงการกระทำปัจจุบัน → -는데요 (가는데요 "คือว่าฉันกำลังไป..."); คำคุณศัพท์ / กริยานุเคราะห์ปัจจุบัน → -(으)ㄴ데요 (비싼데요 "แพงไปหน่อยน่ะ..."); อดีต (ทุกรูป) → -았/었는데요 (왔는데요 "คือว่าเขามาแล้ว..."); อนาคต / คาดเดา → -(으)ㄹ건데요 (รูปไม่ทางการ). ตัว -요 ท้ายทำให้สุภาพ\n\nสามท่าที่พบบ่อย. (1) ค้านอย่างนุ่ม / ไม่เห็นด้วย: 좀 비싼데요... ("แพงไปหน่อยนะคะ...", สื่อให้ "ลดราคาได้ไหม"). (2) เกริ่นบริบทอย่างเป็นกันเอง: 사실 제가 처음인데요... ("ที่จริง ฉันมาเป็นครั้งแรก..."). (3) ตอบสนองด้วยความประหลาดใจเบา ๆ: 와, 정말 잘하시는데요! ("ว้าว เก่งมากเลยนะคะ!"). ลูกพี่ลูกน้องเชิงสนทนา: -데(요)... ที่ห้อยท้ายและให้ผู้ฟังเติม — วัฒนธรรมเกาหลีนิยมการอ้อมแบบนี้มากกว่าการพูดตรง ๆ. อย่าสับสนกับตัวเชื่อมขึ้นต้นประโยค 그런데 ("เอ้อ / แต่") ที่อยู่ต้นประโยคต่อไป',
      'Akhiran kalimat lembut yang menyerahkan giliran berikutnya kepada lawan bicara — "begini sebenarnya... / ya, ...". Bentuk mengikuti aturan pemodifikasi konektor -ㄴ/는데 dari TOPIK 1 tapi di AKHIR kalimat: verba aksi kini → -는데요 (가는데요 "ya, saya akan pergi..."); adjektiva / kopula kini → -(으)ㄴ데요 (비싼데요 "agak mahal sih..."); lampau (apa pun) → -았/었는데요 (왔는데요 "soalnya dia sudah datang..."); masa depan / dugaan → -(으)ㄹ건데요 (informal). Ekor -요 menjaga kesopanan.\n\nTiga gerak umum. (1) Penolakan halus / ketidaksepakatan: 좀 비싼데요... ("agak mahal sih...", mengundang "bisa diskon?"). (2) Pembuka konteks yang ramah: 사실 제가 처음인데요... ("sebenarnya, ini pertama kali saya..."). (3) Reaksi dengan kekaguman ringan: 와, 정말 잘하시는데요! ("wah, Anda hebat sekali!"). Saudara percakapan: -데(요)... yang menggantung di akhir dan dibiarkan diisi lawan bicara — secara kultural Korea lebih suka cara tak langsung ini ketimbang pernyataan datar. Jangan tertukar dengan konektor awal kalimat 그런데 ("ngomong-ngomong / namun"), yang berada di awal kalimat berikutnya.',
      'Đuôi kết câu mềm để chuyển lượt cho người nghe — "chuyện là... / à thì...". Hình thức theo quy tắc định ngữ giống liên từ -ㄴ/는데 ở TOPIK 1 nhưng đặt CUỐI câu: động từ hành động hiện tại → -는데요 (가는데요 "à thì em đang đi..."); tính từ / hệ từ hiện tại → -(으)ㄴ데요 (비싼데요 "đắt quá nhỉ..."); quá khứ (mọi loại) → -았/었는데요 (왔는데요 "chuyện là họ đến rồi..."); tương lai / suy đoán → -(으)ㄹ건데요 (thân mật). Đuôi -요 giữ phép lịch sự.\n\nBa nước đi thường gặp. (1) Phản đối nhẹ / không đồng tình: 좀 비싼데요... ("hơi đắt đấy...", gợi ý "giảm giúp được không?"). (2) Mở bối cảnh thân thiện: 사실 제가 처음인데요... ("thật ra đây là lần đầu của em..."). (3) Phản ứng với chút ngạc nhiên: 와, 정말 잘하시는데요! ("ồ, anh/chị giỏi thật đấy!"). Họ hàng khẩu ngữ: -데(요)... bỏ lửng cuối câu cho người nghe lấp — văn hóa Hàn ưa thích cách gián tiếp này hơn câu khẳng định thẳng băng. Đừng nhầm với liên từ đầu câu 그런데 ("nhân tiện / nhưng") đứng đầu câu kế tiếp.',
      '聞き手に次のターンを委ねる、丁寧で柔らかい文末「〜なんですけど…」。形は TOPIK 1 の接続 -ㄴ/는데 と同じ修飾規則を、文「末」で使う: 現在の動作動詞 → -는데요(가는데요「行くんですけど…」); 現在の形容詞・繋辞 → -(으)ㄴ데요(비싼데요「ちょっと高いんですけど…」); 過去(動詞・形容詞共通) → -았/었는데요(왔는데요「来たんですけど…」); 未来・推量 → -(으)ㄹ건데요(口語的)。末尾の -요 が丁寧さを保つ。\n\nよくある三つの使い分け。(1) やわらかい異議・抵抗: 좀 비싼데요…「ちょっと高いんですけど…」(「もう少し下げてもらえませんか?」を含意)。(2) 親しみのある前置き: 사실 제가 처음인데요…「実は初めてなんですけど…」。(3) 軽い驚きの反応: 와, 정말 잘하시는데요!「わあ、お上手ですね!」。会話的な親戚として、語尾を言いさし的に -데(요)… で残して相手に続きを委ねるのも頻出 — 韓国語文化では、はっきり言い切るより、こうした婉曲を好む。文頭で使う接続 그런데(「ところで／でも」)は別物 — 次の文の先頭に来る。',
    ),
    deckId: 'topik-2',
  },
  ...
  // G058 · How (much / long / etc.)
  {
    ...
    usageNotes: L(
      'A multipurpose "how much / how + adjective" word. It asks DEGREE or QUANTITY of something — distinct from the more specific 몇 ("how many countable"). Common pairings: 얼마나 + verb (얼마나 걸려요? "how long does it take?", 얼마나 자요? "how long do you sleep?"); 얼마나 + adjective (얼마나 멀어요? "how far?", 얼마나 비싸요? "how expensive?"); 얼마나 + frequency adverb (얼마나 자주? "how often?", 얼마나 오래? "how long?"). The matching reply uses a duration / quantity / level.\n\nClose neighbor 얼마 is a noun meaning "amount / price" — used bare for prices: 얼마예요? "how much is it?". 얼마나 is the adverbial / degree side of the family — never put it before a price question (얼마나예요? is wrong; use 얼마예요?). For "how many + counter" use 몇 + counter: 몇 명? ("how many people?"), 몇 시? ("what time?"), 몇 개? ("how many pieces?"). Inside an embedded question, 얼마나 + -(으)ㄴ지 reads as "how X it is": 얼마나 비싼지 몰라요 "you have no idea how expensive it is" — a common emphatic pattern that doubles as an exclamation in everyday speech.',
      'Palabra multiuso para "cuánto / qué tan + adjetivo". Pregunta GRADO o CANTIDAD de algo — distinta del más específico 몇 ("cuántos contables"). Combinaciones frecuentes: 얼마나 + verbo (얼마나 걸려요? "¿cuánto tarda?", 얼마나 자요? "¿cuánto dormís?"); 얼마나 + adjetivo (얼마나 멀어요? "¿qué tan lejos?", 얼마나 비싸요? "¿qué tan caro?"); 얼마나 + adverbio de frecuencia (얼마나 자주? "¿cada cuánto?", 얼마나 오래? "¿cuánto tiempo?"). La respuesta normal lleva una duración, cantidad o nivel.\n\nVecino cercano 얼마 es un sustantivo que significa "monto / precio" — se usa pelado para preguntar precios: 얼마예요? "¿cuánto cuesta?". 얼마나 es el lado adverbial / de grado de la familia — nunca lo pongas delante de una pregunta de precio (얼마나예요? está mal; usá 얼마예요?). Para "cuántos + contador" usá 몇 + contador: 몇 명? ("¿cuántas personas?"), 몇 시? ("¿qué hora?"), 몇 개? ("¿cuántas unidades?"). Dentro de una pregunta indirecta, 얼마나 + -(으)ㄴ지 se lee como "qué tan X es": 얼마나 비싼지 몰라요 "no te imaginás lo caro que es" — patrón enfático común que también funciona como exclamación en el habla diaria.',
      'Mot polyvalent pour « combien / à quel point + adjectif ». Il interroge le DEGRÉ ou la QUANTITÉ — distinct du plus précis 몇 (« combien (dénombrable) »). Combinaisons fréquentes : 얼마나 + verbe (얼마나 걸려요? « combien de temps ça prend ? », 얼마나 자요? « combien de temps dors-tu ? ») ; 얼마나 + adjectif (얼마나 멀어요? « c\'est à quelle distance ? », 얼마나 비싸요? « à quel point c\'est cher ? ») ; 얼마나 + adverbe de fréquence (얼마나 자주? « à quelle fréquence ? », 얼마나 오래? « combien de temps ? »). La réponse propose une durée, une quantité ou un degré.\n\nLe voisin proche 얼마 est un nom signifiant « montant / prix » — employé seul pour les prix : 얼마예요? « combien ça coûte ? ». 얼마나 est le côté adverbial / degré de la famille — ne le place jamais devant une question de prix (얼마나예요? est faux ; il faut 얼마예요?). Pour « combien de + classificateur », emploie 몇 + classificateur : 몇 명? (« combien de personnes ? »), 몇 시? (« quelle heure ? »), 몇 개? (« combien d\'unités ? »). Dans une question indirecte, 얼마나 + -(으)ㄴ지 se lit « à quel point c\'est X » : 얼마나 비싼지 몰라요 « tu n\'imagines pas à quel point c\'est cher » — schéma emphatique courant qui fonctionne aussi comme exclamation à l\'oral.',
      'Palavra multiuso para "quanto / quão + adjetivo". Pergunta GRAU ou QUANTIDADE de algo — diferente do mais específico 몇 ("quantos contáveis"). Combinações comuns: 얼마나 + verbo (얼마나 걸려요? "quanto tempo leva?", 얼마나 자요? "quanto você dorme?"); 얼마나 + adjetivo (얼마나 멀어요? "quão longe?", 얼마나 비싸요? "quão caro?"); 얼마나 + advérbio de frequência (얼마나 자주? "com que frequência?", 얼마나 오래? "por quanto tempo?"). A resposta normalmente traz uma duração, quantidade ou grau.\n\nVizinho próximo 얼마 é um substantivo que significa "valor / preço" — usado sozinho para preços: 얼마예요? "quanto custa?". 얼마나 é o lado adverbial / de grau da família — nunca o coloque diante de uma pergunta de preço (얼마나예요? está errado; use 얼마예요?). Para "quantos + contador" use 몇 + contador: 몇 명? ("quantas pessoas?"), 몇 시? ("que horas?"), 몇 개? ("quantas unidades?"). Dentro de uma pergunta indireta, 얼마나 + -(으)ㄴ지 lê-se como "quão X é": 얼마나 비싼지 몰라요 "você nem imagina como é caro" — padrão enfático comum que também funciona como exclamação na fala.',
      'คำที่ใช้ได้หลายแบบสำหรับ "เท่าไหร่ / มาก/นานแค่ไหน + คำคุณศัพท์". ถามถึง "ระดับ" หรือ "ปริมาณ" — ต่างจาก 몇 ที่เฉพาะกว่า ("กี่ + ลักษณนาม"). คู่ที่พบบ่อย: 얼마나 + กริยา (얼마나 걸려요? "ใช้เวลาเท่าไหร่?", 얼마나 자요? "นอนนานเท่าไหร่?"); 얼마나 + คำคุณศัพท์ (얼마나 멀어요? "ไกลแค่ไหน?", 얼마나 비싸요? "แพงแค่ไหน?"); 얼마나 + คำบอกความถี่ (얼마나 자주? "บ่อยแค่ไหน?", 얼마나 오래? "นานแค่ไหน?"). คำตอบมักให้ระยะเวลา ปริมาณ หรือระดับ\n\nเพื่อนบ้านใกล้ ๆ 얼마 เป็นคำนามแปลว่า "จำนวน / ราคา" — ใช้เปล่า ๆ ถามราคา: 얼마예요? "เท่าไหร่คะ?". 얼마나 เป็นด้านวิเศษณ์ / ระดับของตระกูล — อย่าใช้นำหน้าคำถามเรื่องราคา (얼마나예요? ผิด ใช้ 얼마예요? เท่านั้น). หาก "กี่ + ลักษณนาม" ใช้ 몇 + ลักษณนาม: 몇 명? ("กี่คน?"), 몇 시? ("กี่โมง?"), 몇 개? ("กี่อัน?"). ในคำถามอ้อม 얼마나 + -(으)ㄴ지 อ่านว่า "X มากแค่ไหน": 얼마나 비싼지 몰라요 "นึกไม่ออกว่าแพงขนาดไหน" — เป็นสำนวนเน้นที่ใช้บ่อยและทำหน้าที่เป็นคำอุทานในการพูดประจำวันได้ด้วย',
      'Kata serbaguna untuk "seberapa / berapa + adjektiva". Menanyakan KADAR atau JUMLAH sesuatu — beda dengan 몇 yang lebih spesifik ("berapa + penggolong"). Pasangan umum: 얼마나 + verba (얼마나 걸려요? "berapa lama?", 얼마나 자요? "berapa lama tidurmu?"); 얼마나 + adjektiva (얼마나 멀어요? "seberapa jauh?", 얼마나 비싸요? "seberapa mahal?"); 얼마나 + adverbia frekuensi (얼마나 자주? "seberapa sering?", 얼마나 오래? "seberapa lama?"). Jawabannya berupa durasi, jumlah, atau tingkat.\n\nTetangga dekat 얼마 adalah kata benda yang berarti "jumlah / harga" — dipakai sendiri untuk menanyakan harga: 얼마예요? "berapa harganya?". 얼마나 adalah sisi adverbia / kadar dari keluarga ini — jangan letakkan di depan pertanyaan harga (얼마나예요? salah; pakai 얼마예요? saja). Untuk "berapa + penggolong" pakai 몇 + penggolong: 몇 명? ("berapa orang?"), 몇 시? ("jam berapa?"), 몇 개? ("berapa biji?"). Di dalam pertanyaan tak langsung, 얼마나 + -(으)ㄴ지 berbunyi "seberapa X": 얼마나 비싼지 몰라요 "kamu tidak bisa membayangkan betapa mahalnya" — pola tegas umum yang juga berfungsi sebagai seruan dalam percakapan sehari-hari.',
      'Từ đa năng cho "bao nhiêu / đến mức nào + tính từ". Hỏi MỨC ĐỘ hoặc SỐ LƯỢNG của một thứ — khác với 몇 cụ thể hơn ("mấy + loại từ"). Cặp ghép thường gặp: 얼마나 + động từ (얼마나 걸려요? "mất bao lâu?", 얼마나 자요? "bạn ngủ bao lâu?"); 얼마나 + tính từ (얼마나 멀어요? "xa cỡ nào?", 얼마나 비싸요? "đắt cỡ nào?"); 얼마나 + trạng từ tần suất (얼마나 자주? "bao lâu một lần?", 얼마나 오래? "bao lâu?"). Câu trả lời thường đưa thời lượng, số lượng hoặc cấp độ.\n\nHàng xóm gần 얼마 là danh từ nghĩa "số tiền / giá" — dùng trần trụi để hỏi giá: 얼마예요? "bao nhiêu tiền?". 얼마나 là phía trạng từ / mức độ của gia đình này — không bao giờ đặt trước câu hỏi giá (얼마나예요? sai; chỉ dùng 얼마예요?). Để hỏi "mấy + loại từ" dùng 몇 + loại từ: 몇 명? ("mấy người?"), 몇 시? ("mấy giờ?"), 몇 개? ("mấy cái?"). Trong câu hỏi gián tiếp, 얼마나 + -(으)ㄴ지 đọc thành "X đến mức nào": 얼마나 비싼지 몰라요 "bạn không thể tưởng tượng nó đắt đến mức nào" — mẫu nhấn mạnh phổ biến, đồng thời là cảm thán trong khẩu ngữ.',
      '「どのくらい／どれだけ／どれほど + 形容詞」を尋ねる多用途の語。「程度」「量」を問うのが本領で、「いくつ(可算)」を聞く 몇 とは別物。よく組む形: 얼마나 + 動詞(얼마나 걸려요?「どのくらいかかりますか?」、얼마나 자요?「どのくらい眠りますか?」); 얼마나 + 形容詞(얼마나 멀어요?「どのくらい遠いですか?」、얼마나 비싸요?「どのくらい高いですか?」); 얼마나 + 頻度副詞(얼마나 자주?「どのくらいの頻度で?」、얼마나 오래?「どのくらいの間?」)。返答は所要時間・量・程度を入れる。\n\n近隣の 얼마 は「金額・値段」を意味する名詞で、値段を問うときは単独で使う: 얼마예요?「いくらですか?」。얼마나 は副詞・程度側の用法で、値段の質問の前に置いてはいけない(얼마나예요? は不可、얼마예요? を使う)。「いくつ + 助数詞」を尋ねるときは 몇 + 助数詞: 몇 명?「何人?」、몇 시?「何時?」、몇 개?「何個?」。間接疑問では 얼마나 + -(으)ㄴ지 で「どれほど〜か」と読む: 얼마나 비싼지 몰라요「どれほど高いかと言うと(言葉にできないくらい)」 — 日常会話で強い感嘆としても多用される定番。',
    ),
    deckId: 'topik-2',
  },
  ...
  // G054 · About / regarding
  {
    ...
    usageNotes: L(
      'Means "about / regarding / concerning". Form: noun + 에 대해(서) (한국 문화에 대해서 이야기해요 "we\'re talking about Korean culture"). The 서 is optional and basically interchangeable — 에 대해 and 에 대해서 both work, with 서 slightly more frequent in speech. Built from the noun-marking 에 + the verb 대하다 ("to face / treat / be about"). Pairs naturally with verbs of speaking, thinking, learning: 이야기하다, 말하다, 생각하다, 배우다, 알다, 쓰다.\n\nThree register variants worth knowing. (1) Adverbial: -에 대해(서) (most common, used before a verb). (2) Noun-modifier: -에 대한 + N ("about-X" book, "about-Y" research): 한국에 대한 책 "a book about Korea". (3) More formal / written: -에 관해서 ("concerning"), -에 관한 + N (한국에 관한 책). For "with respect to / when it comes to", the more conversational 에 관해서 alternative is -에 있어서 ("when it comes to"), but it\'s heavier. Don\'t confuse with the unrelated 대해서요? ("excuse me?") which is just 대하다 in a different sense — context will keep them apart.',
      'Significa "sobre / acerca de / respecto a". Forma: sustantivo + 에 대해(서) (한국 문화에 대해서 이야기해요 "hablamos sobre la cultura coreana"). El 서 es opcional y básicamente intercambiable — 에 대해 y 에 대해서 ambos funcionan, con 서 un poco más frecuente al hablar. Se construye sobre la marca 에 + el verbo 대하다 ("enfrentar / tratar / ser sobre"). Se empareja naturalmente con verbos de hablar, pensar, aprender: 이야기하다, 말하다, 생각하다, 배우다, 알다, 쓰다.\n\nTres variantes de registro a saber. (1) Adverbial: -에 대해(서) (lo más común, antes de un verbo). (2) Modificador de sustantivo: -에 대한 + N (libro "sobre X", investigación "sobre Y"): 한국에 대한 책 "un libro sobre Corea". (3) Más formal / escrita: -에 관해서 ("en cuanto a"), -에 관한 + N (한국에 관한 책). Para "en lo que respecta a / hablando de", la alternativa más conversacional de 에 관해서 es -에 있어서 ("en cuanto a"), pero pesa más. No lo confundas con el no relacionado 대해서요? ("¿perdón?") que es 대하다 en otro sentido — el contexto los separa.',
      'Signifie « à propos de / concernant / au sujet de ». Forme : nom + 에 대해(서) (한국 문화에 대해서 이야기해요 « on parle de la culture coréenne »). Le 서 est facultatif et essentiellement interchangeable — 에 대해 et 에 대해서 fonctionnent tous deux, 서 étant un peu plus fréquent à l\'oral. Construit sur 에 (marqueur de point) + le verbe 대하다 (« faire face / traiter / porter sur »). S\'associe naturellement aux verbes de parole, de pensée, d\'apprentissage : 이야기하다, 말하다, 생각하다, 배우다, 알다, 쓰다.\n\nTrois variantes de registre à connaître. (1) Adverbial : -에 대해(서) (le plus courant, avant un verbe). (2) Modificateur nominal : -에 대한 + N (livre « sur X », étude « sur Y ») : 한국에 대한 책 « un livre sur la Corée ». (3) Plus formel / écrit : -에 관해서 (« concernant »), -에 관한 + N (한국에 관한 책). Pour « en ce qui concerne », l\'alternative plus orale à 에 관해서 est -에 있어서 (« quant à »), mais c\'est plus lourd. À ne pas confondre avec le 대해서요? sans rapport (« pardon ? »), qui est 대하다 dans un autre sens — le contexte permet de les distinguer.',
      'Significa "sobre / a respeito de / acerca de". Forma: substantivo + 에 대해(서) (한국 문화에 대해서 이야기해요 "falamos sobre cultura coreana"). O 서 é opcional e essencialmente intercambiável — 에 대해 e 에 대해서 funcionam, com 서 um pouco mais frequente na fala. Construído sobre o marcador 에 + o verbo 대하다 ("encarar / tratar / ser sobre"). Combina naturalmente com verbos de falar, pensar, aprender: 이야기하다, 말하다, 생각하다, 배우다, 알다, 쓰다.\n\nTrês variantes de registro a saber. (1) Adverbial: -에 대해(서) (a mais comum, antes de um verbo). (2) Modificador de substantivo: -에 대한 + N (livro "sobre X", pesquisa "sobre Y"): 한국에 대한 책 "um livro sobre a Coreia". (3) Mais formal / escrita: -에 관해서 ("a respeito de"), -에 관한 + N (한국에 관한 책). Para "no que diz respeito a", a alternativa mais conversacional de 에 관해서 é -에 있어서 ("quanto a"), mas é mais pesada. Não confunda com o desconectado 대해서요? ("como?"), que é 대하다 em outro sentido — o contexto os separa.',
      'แปลว่า "เกี่ยวกับ / ในเรื่อง". รูป: คำนาม + 에 대해(서) (한국 문화에 대해서 이야기해요 "พวกเราคุยกันเรื่องวัฒนธรรมเกาหลี"). 서 ใส่หรือไม่ใส่ก็ได้ — 에 대해 และ 에 대해서 ใช้ได้ทั้งคู่ โดยมี 서 พบบ่อยกว่าในการพูด. สร้างจากตัวบอกตำแหน่ง 에 + กริยา 대하다 ("เผชิญ / รับมือ / เกี่ยวกับ"). คู่กับกริยาแสดงการพูด คิด เรียนรู้: 이야기하다, 말하다, 생각하다, 배우다, 알다, 쓰다 ได้อย่างเป็นธรรมชาติ\n\nสามรูปตามระดับภาษาที่ควรรู้. (1) วิเศษณ์: -에 대해(서) (พบบ่อยที่สุด อยู่หน้ากริยา). (2) ตัวขยายคำนาม: -에 대한 + คำนาม (หนังสือ "เกี่ยวกับ X", งานวิจัย "เกี่ยวกับ Y"): 한국에 대한 책 "หนังสือเกี่ยวกับเกาหลี". (3) ทางการ/เขียนกว่า: -에 관해서 ("เกี่ยวเนื่องกับ"), -에 관한 + N (한국에 관한 책). หากจะแปลว่า "ในแง่ของ / ในเรื่อง" ทางเลือกเชิงพูดของ 에 관해서 คือ -에 있어서 ("ในเรื่องของ") แต่หนักกว่า. อย่าสับสนกับ 대해서요? ("อะไรนะคะ?") ซึ่งใช้ 대하다 ในความหมายอื่น — บริบทจะแยกออก',
      'Berarti "tentang / mengenai / berkenaan dengan". Bentuk: kata benda + 에 대해(서) (한국 문화에 대해서 이야기해요 "kami berbicara tentang budaya Korea"). 서 opsional dan pada dasarnya bisa dipertukarkan — 에 대해 dan 에 대해서 sama-sama dipakai, dengan 서 sedikit lebih sering muncul saat bicara. Dibangun dari penanda 에 + verba 대하다 ("menghadapi / memperlakukan / berkenaan dengan"). Cocok dengan verba berbicara, berpikir, belajar: 이야기하다, 말하다, 생각하다, 배우다, 알다, 쓰다.\n\nTiga varian register yang perlu dikuasai. (1) Adverbial: -에 대해(서) (paling umum, sebelum verba). (2) Pemodifikasi kata benda: -에 대한 + N (buku "tentang X", riset "tentang Y"): 한국에 대한 책 "buku tentang Korea". (3) Lebih formal / tulis: -에 관해서 ("perihal"), -에 관한 + N (한국에 관한 책). Untuk "dalam hal", alternatif yang lebih percakapan dari 에 관해서 adalah -에 있어서 ("mengenai"), tapi lebih berat. Jangan tertukar dengan 대해서요? ("apa?") yang tak berhubungan dan memakai 대하다 dalam arti lain — konteks akan memisahkan.',
      'Nghĩa "về / liên quan đến / nói về". Hình thức: danh từ + 에 대해(서) (한국 문화에 대해서 이야기해요 "chúng tôi nói chuyện về văn hóa Hàn Quốc"). 서 là tuỳ chọn và về cơ bản thay thế cho nhau — 에 대해 và 에 대해서 đều dùng được, 서 hơi phổ biến hơn trong khẩu ngữ. Cấu tạo từ dấu vị trí 에 + động từ 대하다 ("đối diện / xử lý / liên quan đến"). Hay kết hợp với động từ nói, nghĩ, học: 이야기하다, 말하다, 생각하다, 배우다, 알다, 쓰다.\n\nBa biến thể cấp độ cần nắm. (1) Trạng từ: -에 대해(서) (phổ biến nhất, trước động từ). (2) Định ngữ cho danh từ: -에 대한 + N (sách "về X", nghiên cứu "về Y"): 한국에 대한 책 "cuốn sách về Hàn Quốc". (3) Trang trọng / văn viết hơn: -에 관해서 ("liên quan đến"), -에 관한 + N (한국에 관한 책). Để nói "về phương diện", lựa chọn thân mật hơn của 에 관해서 là -에 있어서 ("xét về"), nhưng nặng hơn. Đừng nhầm với 대해서요? ("dạ?"), vốn dùng 대하다 theo nghĩa khác — ngữ cảnh sẽ phân biệt.',
      '「〜について／〜に関して」を意味する。形: 名詞 + 에 대해(서)(한국 문화에 대해서 이야기해요「韓国の文化について話します」)。서 は付けても付けなくてもよく、実質的に置換可能 — 에 대해 と 에 대해서 はどちらも使え、会話では 서 を付けるほうがやや多い。位置を示す 에 + 動詞 대하다(「向き合う・扱う・関する」)から成る。話す・考える・学ぶ系の動詞と相性がよい: 이야기하다、말하다、생각하다、배우다、알다、쓰다。\n\n知っておきたい3つの語形・レジスター。(1) 副詞: -에 대해(서)(最頻出。動詞の前)。(2) 連体修飾: -에 대한 + N(「Xについての本」「Yに関する研究」など): 한국에 대한 책「韓国に関する本」。(3) よりフォーマル・文章的: -에 관해서(「〜に関しまして」)、-에 관한 + N(한국에 관한 책)。「〜に関しては」と少し改まって言いたいときの口語的選択肢は -에 있어서 だが重め。無関係な 대해서요?(「なんですって?」)は 대하다 の別の意味で、文脈で区別可能。',
    ),
    deckId: 'topik-2',
  },
